...
def floatToFixed(value, precisionBits): # -> int:
...
def fixedToStr(value, precisionBits): # -> str:
...
def strToFixed(string, precisionBits): # -> int:
...
def floatToFixedToStr(value, precisionBits): # -> str:
...
def ensureVersionIsLong(value): # -> int:
...
def versionToFixed(value): # -> int | float:
