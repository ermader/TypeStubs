...
class KDTree(cKDTree):
    ...
    def query(self, x, k=..., eps=..., p=..., distance_upper_bound=..., workers=...): # -> tuple[list[Any], list[Unknown]] | tuple[Any, Any] | tuple[Any, intp | Any]:
    ...
    def count_neighbors(self, other, r, p=..., weights=..., cumulative=...): # -> int:
