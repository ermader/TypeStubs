...
def jnjnp_zeros(nt): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
...
def riccati_jn(n, x): # -> tuple[Unknown, Unknown]:
...
def riccati_yn(n, x): # -> tuple[Unknown, Unknown]:
...
def fresnel_zeros(nt): # -> tuple[Unknown, Unknown]:
...
def lpmn(m, n, z): # -> tuple[Unknown, Unknown]:
...
def clpmn(m, n, z, type=...): # -> tuple[Unknown, Unknown]:
...
def lqmn(m, n, z): # -> tuple[Unknown, Unknown]:
...
def lpn(n, z): # -> tuple[Unknown, Unknown]:
...
def lqn(n, z): # -> tuple[Unknown, Unknown]:
...
def lmbda(v, x): # -> tuple[Unknown, Unknown]:
...
def pbdv_seq(v, x): # -> tuple[Unknown, Unknown]:
...
def pbvv_seq(v, x): # -> tuple[Unknown, Unknown]:
...
def pbdn_seq(n, z): # -> tuple[Unknown, Unknown]:
...
def kelvin_zeros(nt): # -> tuple[Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown]:
...
def factorial2(n, exact=...): # -> int | NDArray[Any]:
    """Double factorial.
