...
_ArrayLike0D = Union[bool, int, float, complex, str, bytes, numpy.generic],
...
class orthopoly1d(numpy.poly1d):
    def __init__(self, roots: numpy.typing.ArrayLike, weights: Optional[numpy.typing.ArrayLike], hn: float = ..., kn: float = ..., wfunc=..., limits=..., monic: bool = ..., eval_func: numpy.ufunc = ...) -> None:
        ...
