...
def cumtrapz(y, x=..., dx=..., axis=..., initial=...): # -> NDArray[_SCT@concatenate] | ndarray[Unknown, Unknown]:
...
def cumulative_trapezoid(y, x=..., dx=..., axis=..., initial=...): # -> NDArray[_SCT@concatenate] | ndarray[Unknown, Unknown]:
    """
...
def simps(y, x=..., dx=..., axis=..., even=...): # -> Any | float:
    """`An alias of `simpson`.
