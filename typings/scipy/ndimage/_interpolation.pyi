...
@docfiller
def spline_filter1d(input, order=..., axis=..., output=..., mode=...): # -> NDArray[Any] | NDArray[_SCT@zeros]:
    """
...
def spline_filter(input, order=..., output=..., mode=...): # -> NDArray[Any] | NDArray[_SCT@zeros]:
    """
...
@docfiller
def geometric_transform(input, mapping, output_shape=..., output=..., order=..., mode=..., cval=..., prefilter=..., extra_arguments=..., extra_keywords=...): # -> NDArray[Any] | NDArray[_SCT@zeros]:
    """
...
@docfiller
def map_coordinates(input, coordinates, output=..., order=..., mode=..., cval=..., prefilter=...): # -> NDArray[Any] | NDArray[_SCT@zeros]:
    """
...
@docfiller
def shift(input, shift, output=..., order=..., mode=..., cval=..., prefilter=...): # -> NDArray[Any] | NDArray[_SCT@zeros]:
    """
    Shift an array.
...
@docfiller
def rotate(input, angle, axes=..., reshape=..., output=..., order=..., mode=..., cval=..., prefilter=...): # -> NDArray[Any] | NDArray[_SCT@zeros]:
    """
    Rotate an array.
