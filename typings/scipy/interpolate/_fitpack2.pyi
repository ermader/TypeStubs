...
class UnivariateSpline:
    ...
    **NaN handling**: If the input arrays contain ``nan`` values, the result
    ...
    def __call__(self, x, nu=..., ext=...): # -> NDArray[_SCT@array] | ndarray[Any, dtype[complex_ | float_]] | list[Unknown] | Any:
        """
...
class BivariateSpline(_BivariateSplineBase):
    ...
    bisplev :
        a function to evaluate a bivariate B-spline and its derivatives
    """
    def ev(self, xi, yi, dx=..., dy=...): # -> NDArray[float64] | Any:
        """
...
class SphereBivariateSpline(_BivariateSplineBase):
    ...
    """
    def __call__(self, theta, phi, dtheta=..., dphi=..., grid=...): # -> NDArray[float64] | Any:
        """
        Evaluate the spline or its derivatives at given positions.
    ...
    def ev(self, theta, phi, dtheta=..., dphi=...): # -> NDArray[float64] | Any:
        """
        Evaluate the spline at points
