...
class BSpline:
    ...
    **Implementation details**
    ...
    @property
    def tck(self): # -> tuple[NDArray[_SCT@ascontiguousarray], NDArray[_SCT@asarray] | NDArray[_SCT@ascontiguousarray], int]:
    ...
    @classmethod
    def design_matrix(cls, x, t, k): # -> csr_array:
        """
    ...
    @classmethod
    def from_power_basis(cls, pp, bc_type=...):
        r"""
