...
def prepare_input(x, y, axis, dydx=...): # -> tuple[NDArray[Any], NDArray[Any], NDArray[_SCT@moveaxis], Unknown, NDArray[_SCT@moveaxis] | Unknown | None]:
...
def pchip_interpolate(xi, yi, x, der=..., axis=...): # -> ndarray[Any, dtype[_SCT@asarray | complex_ | float_]] | list[Unknown | ndarray[Any, dtype[_SCT@asarray | complex_ | float_]]]:
    """
