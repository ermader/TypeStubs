...
class interp1d(_Interpolator1D):
    ...
    @property
    def fill_value(self): # -> tuple[Unknown, ...] | NDArray[_SCT@asarray]:
        """The fill value."""
        ...
...
class _PPolyBase:
    ...
    def __call__(self, x, nu=..., extrapolate=...): # -> ndarray[Any, dtype[_SCT@asarray | complex_ | float_]]:
        """
...
class NdPPoly:
    ...
    def integrate(self, ranges, extrapolate=...): # -> NDArray[_SCT@asarray] | NDArray[_SCT@ascontiguousarray] | Any:
        """
        Compute a definite integral over a piecewise polynomial.
...
class RegularGridInterpolator:
    ...
    *nearest*) may be chosen at each evaluation.
    ...
    def __call__(self, xi, method=...): # -> ndarray[Any, dtype[floating[Any]]] | Any:
        """
...
class _ppform(PPoly):
    ...
    def __call__(self, x): # -> ndarray[Any, dtype[_SCT@asarray | complex_ | float_]]:
        ...
