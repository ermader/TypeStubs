...
class NumericalInverseHermite:
    @_deprecated("NumericalInverseHermite has been deprecated from `scipy.stats`. " " To use `NumericalInverseHermite`, import/use it from " "`scipy.stats.sampling` module instead. " "i.e. `from scipy.stats.sampling import NumericalInverseHermite`")
