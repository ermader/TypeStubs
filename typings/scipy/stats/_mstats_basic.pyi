"""
This type stub file (basic) was generated by pyright.
"""
...
def find_repeats(
    arr,
):  # -> tuple[NDArray[_SCT@array], NDArray[_SCT@array]] | tuple[Any, Any]:
...
def pearsonr(
    x, y
):  # -> tuple[MaskedConstant, MaskedConstant] | tuple[float, float] | tuple[Any, float] | tuple[Any, Any]:
    r"""
...
def spearmanr(x, y=..., use_ties=..., axis=..., nan_policy=..., alternative=...):
    """
...
def kendalltau(x, y, use_ties=..., use_missing=..., method=..., alternative=...):
    """
...
def linregress(
    x: list[float], y: typing.Optional[list[float]] = ...
...
def theilslopes(
    y, x=..., alpha=..., method=...
):  # -> tuple[floating[Any], floating[Any], Unknown, Unknown]:
    r"""
...
def siegelslopes(y, x=..., method=...):  # -> tuple[floating[Any], floating[Any]]:
    r"""
...
def ks_2samp(data1, data2, alternative=..., mode=...):  # -> KstestResult:
    """
