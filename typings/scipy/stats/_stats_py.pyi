...
def moment(a, moment=..., axis=..., nan_policy=...): # -> float64 | NDArray[_SCT@full] | Any:
...
def skew(a, axis=..., bias=..., nan_policy=...): # -> Any | NDArray[Any]:
...
def kurtosis(a, axis=..., fisher=..., bias=..., nan_policy=...): # -> Any | NDArray[signedinteger[Any]] | NDArray[Any]:
...
@np.deprecate(message="`itemfreq` is deprecated and will be removed in a " "future version. Use instead `np.unique(..., return_counts=True)`")
def itemfreq(a): # -> NDArray[_SCT@array]:
    """
...
def scoreatpercentile(a, per, limit=..., interpolation_method=..., axis=...): # -> float | NDArray[_SCT@full] | NDArray[_SCT@array] | Any:
...
def obrientransform(*args): # -> NDArray[Any] | NDArray[_SCT@array]:
...
def median_abs_deviation(x, axis=..., center=..., scale=..., nan_policy=...): # -> float | NDArray[Any] | floating[Any] | NDArray[floating[Any]] | Any:
    r"""
...
def median_absolute_deviation(x, axis=..., center=..., scale=..., nan_policy=...): # -> float | NDArray[Any] | floating[Any] | NDArray[floating[Any]] | Any:
    r"""
Compute the median absolute deviation of the data along the given axis.
...
def trimboth(a, proportiontocut, axis=...): # -> NDArray[_SCT@asarray] | ndarray[Any, Unknown]:
...
def trim1(a, proportiontocut, tail=..., axis=...): # -> ndarray[Any, Unknown] | list[Unknown]:
...
def pearsonr(x, y): # -> tuple[float, float] | tuple[Any, float] | tuple[Any, Any]:
    r"""
...
Ttest_relResult = ...
def ttest_rel(a, b, axis=..., nan_policy=..., alternative=...): # -> Ttest_relResult:
...
def combine_pvalues(pvalues, method=..., weights=...): # -> tuple[Any, Any | NDArray[_SCT@zeros]]:
    """
...
def rankdata(a, method=..., *, axis=...): # -> NDArray[_SCT@empty] | NDArray[_SCT@apply_along_axis] | NDArray[signedinteger[Any]] | Any:
