...
class spmatrix:
    ...
    def __pow__(self, other): # -> dia_array | csr_matrix | csc_matrix | coo_matrix | Self@spmatrix | Any | _NotImplementedType:
        ...
    ...
    def todense(self, order=..., out=...): # -> NDArray[_SCT@asarray] | matrix[Unknown, Unknown]:
        """
