...
def gmres_loose(A, b, tol): # -> tuple[ndarray[Any, Unknown] | Unknown, Literal[0]] | tuple[ndarray[Any, Unknown] | Any, int | Any]:
    """
...
def get_inv_matvec(M, hermitian=..., tol=...): # -> (x: Unknown) -> (Unknown | ndarray[Any, dtype[Unknown]] | ndarray[Any, Unknown]):
    ...
