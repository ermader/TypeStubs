...
class LinearOperator:
    ...
    def matmat(self, X): # -> matrix[Any, dtype[Unknown]] | matrix[Unknown, Unknown] | NDArray[_SCT@hstack]:
    ...
    def rmatmat(self, X): # -> matrix[Any, dtype[Any]] | Any | matrix[Unknown, Unknown] | NDArray[_SCT@hstack]:
    ...
    def __mul__(self, x): # -> _ProductLinearOperator | _ScaledLinearOperator | ndarray[Any, Unknown] | ndarray[Any, dtype[Unknown]] | matrix[Unknown, Unknown]:
        ...
    
    def dot(self, x): # -> _ProductLinearOperator | _ScaledLinearOperator | ndarray[Any, Unknown] | ndarray[Any, dtype[Unknown]] | matrix[Unknown, Unknown]:
    ...
    def __matmul__(self, other): # -> _ProductLinearOperator | _ScaledLinearOperator | ndarray[Any, Unknown] | ndarray[Any, dtype[Unknown]] | matrix[Unknown, Unknown]:
        ...
