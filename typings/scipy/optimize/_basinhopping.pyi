...
def basinhopping(func, x0, niter=..., T=..., stepsize=..., minimizer_kwargs=..., take_step=..., accept_test=..., callback=..., interval=..., disp=..., niter_success=..., seed=..., *, target_accept_rate=..., stepwise_factor=...):
