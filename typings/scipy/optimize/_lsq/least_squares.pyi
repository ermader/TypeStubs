...
def prepare_bounds(bounds, n): # -> tuple[ndarray[Unknown, Unknown] | NDArray[Any], ndarray[Unknown, Unknown] | NDArray[Any]]:
    ...
...
def check_jac_sparsity(jac_sparsity, m, n): # -> tuple[NDArray[_SCT@atleast_2d] | Unknown, Unknown] | None:
    ...
...
IMPLEMENTED_LOSSES = ...
def construct_loss_function(m, loss, f_scale): # -> ((f: Unknown, cost_only: bool = False) -> (Unknown | NDArray[float64])) | None:
    ...
