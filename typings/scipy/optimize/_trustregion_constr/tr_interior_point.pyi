...
class BarrierSubproblem:
    ...
    def function_and_constraints(self, z): # -> tuple[Unknown, NDArray[_SCT@hstack]]:
    ...
    def gradient_and_jacobian(self, z): # -> tuple[NDArray[_SCT@hstack], Unknown | csr_matrix | NDArray[_SCT@block]]:
