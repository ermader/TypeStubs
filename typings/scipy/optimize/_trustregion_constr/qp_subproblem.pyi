...
def sphere_intersections(z, d, trust_radius, entire_line=...): # -> tuple[Literal[0], Literal[0], Literal[False]] | tuple[float | Literal[0], float | Literal[1], Literal[True]] | tuple[Any | Unknown | int, Any | Unknown | int, bool]:
...
def box_sphere_intersections(z, d, lb, ub, trust_radius, entire_line=..., extra_info=...): # -> tuple[Any, Any, bool, dict[str, float | Any | Unknown | int | bool], dict[str, int | Any | bool]] | tuple[Any, Any, bool]:
