...
class VisitingDistribution:
    ...
    def visiting(self, x, step, temperature): # -> NDArray[_SCT@copy]:
...
class EnergyState:
    ...
    def reset(self, func_wrapper, rand_gen, x0=...):
        """
    ...
    def update_best(self, e, x, context): # -> Literal['Callback function requested to stop early by returning True'] | None:
        ...
...
class StrategyChain:
    ...
    def local_search(self): # -> Literal['Maximum number of function call reached during local search', 'Maximum number of function call reached during dual annealing'] | None:
        ...
...
def dual_annealing(func, bounds, args=..., maxiter=..., minimizer_kwargs=..., initial_temp=..., restart_temp_ratio=..., visit=..., accept=..., maxfun=..., seed=..., no_local_search=..., callback=..., x0=..., local_search_options=...):
    """
