...
def cholesky(a, lower=..., overwrite_a=..., check_finite=...): # -> NDArray[_SCT@atleast_2d]:
    """
...
def cho_factor(a, lower=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[_SCT@atleast_2d] | Unknown, bool]:
    """
