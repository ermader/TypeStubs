...
def expm_frechet(A, E, method=..., compute_expm=..., check_finite=...): # -> tuple[Any | ndarray[Any, dtype[Unknown]] | Unknown | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float_]], Any | ndarray[Any, dtype[Unknown]] | Unknown | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float_]]] | Any | ndarray[Any, dtype[Unknown]] | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float_]]:
    """
...
def expm_frechet_block_enlarge(A, E): # -> tuple[ndarray[Any, dtype[Unknown]] | Unknown | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float_]], ndarray[Any, dtype[Unknown]] | Unknown | ndarray[Any, dtype[Any]] | ndarray[Any, dtype[float_]]]:
    """
...
ell_table_61 = ...
def expm_frechet_algo_64(A, E): # -> tuple[Any, Any]:
    ...
...
def expm_frechet_kronform(A, method=..., check_finite=...): # -> NDArray[_SCT@vstack]:
    """
...
def expm_cond(A, check_finite=...): # -> floating[Any]:
    """
