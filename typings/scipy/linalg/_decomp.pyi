...
def hessenberg(a, calc_q=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[_SCT@asarray_chkfinite], NDArray[float64]] | NDArray[_SCT@asarray_chkfinite] | tuple[NDArray[_SCT@triu], Unknown]:
    """
...
def cdf2rdf(w, v): # -> tuple[NDArray[_SCT@zeros], Any]:
    """
