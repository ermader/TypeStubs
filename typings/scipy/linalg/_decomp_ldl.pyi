...
__all__ = ['ldl']
def ldl(A, lower=..., hermitian=..., overwrite_a=..., check_finite=...): # -> tuple[NDArray[_SCT@atleast_2d], NDArray[_SCT@atleast_2d], NDArray[Any]] | tuple[NDArray[_SCT@tril], NDArray[_SCT@diag], ndarray[Unknown, Unknown]]:
