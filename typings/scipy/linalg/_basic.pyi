...
def solve_toeplitz(c_or_cr, b, check_finite=...): # -> Any | ndarray[Any, dtype[Any]]:
...
def solve_circulant(c, b, singular=..., tol=..., caxis=..., baxis=..., outaxis=...): # -> NDArray[_SCT@moveaxis] | ndarray[Any, _dtype] | NDArray[complex128]:
...
def pinv2(a, cond=..., rcond=..., return_rank=..., check_finite=...): # -> tuple[Unknown, Any]:
    """
    Compute the (Moore-Penrose) pseudo-inverse of a matrix.
...
def matrix_balance(A, permute=..., scale=..., separate=..., overwrite_a=...): # -> tuple[Unknown, tuple[NDArray[Any], NDArray[signedinteger[Any]]]] | tuple[Unknown, ndarray[Any, dtype[Any]]]:
    """
