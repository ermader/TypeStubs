...
"""
def compute_all_knots(x, df, degree): # -> tuple[NDArray[_SCT@concatenate], Any, Any, ndarray[Any, dtype[floating[Any]]]]:
    ...

def make_bsplines_basis(x, df, degree): # -> tuple[NDArray[Any] | Any, NDArray[Any] | Any, NDArray[Any] | Any]:
...
def make_poly_basis(x, degree, intercept=...): # -> tuple[NDArray[float64], NDArray[float64], NDArray[float64]]:
    '''
...
class UnivariateBSplines(UnivariateGamSmoother):
    ...
    def transform(self, x_new, deriv=..., skip_ctransf=...): # -> tuple[NDArray[Any] | Unbound, NDArray[Any] | Unbound, NDArray[Any] | Unbound] | NDArray[Any]:
...
class UnivariateCubicSplines(UnivariateGamSmoother):
    ...
    def transform(self, x_new): # -> Any | NDArray[float64]:
        ...
...
class AdditiveGamSmoother(with_metaclass(ABCMeta)):
    ...
    def transform(self, x_new): # -> NDArray[_SCT@hstack]:
        """create the spline basis for new observations
