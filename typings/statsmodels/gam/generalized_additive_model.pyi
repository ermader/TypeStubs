...
class GLMGamResults(GLMResults):
    ...
    def predict(self, exog=..., exog_smooth=..., transform=..., **kwargs): # -> Series[Unknown] | DataFrame:
        """"
        compute prediction
...
class GLMGam(PenalizedMixin, GLM):
    ...
    **kwargs
    ...
    def select_penweight(self, criterion=..., start_params=..., start_model_params=..., method=..., **fit_kwds): # -> tuple[Any, Unknown, dict[Unknown, Unknown]]:
...
def make_augmented_matrix(endog, exog, penalty_matrix, weights): # -> tuple[NDArray[Any], NDArray[_SCT@vstack], NDArray[_SCT@concatenate]]:
