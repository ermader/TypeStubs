...
def cov_hc0(results): # -> Any:
    """
    See statsmodels.RegressionResults
    """
    ...

def cov_hc1(results): # -> Any:
    """
    See statsmodels.RegressionResults
    """
    ...

def cov_hc2(results): # -> Any:
    """
    See statsmodels.RegressionResults
    """
    ...

def cov_hc3(results): # -> Any:
    """
    See statsmodels.RegressionResults
    """
    ...
...
def weights_uniform(nlags): # -> NDArray[float64]:
...
kernel_dict = ...
def S_hac_simple(x, nlags=..., weights_func=...): # -> Any:
...
def S_hac_groupsum(x, time, nlags=..., weights_func=...): # -> Any:
...
def S_crosssection(x, group): # -> Any:
...
def cov_crosssection_0(results, group): # -> Any:
    '''this one is still wrong, use cov_cluster instead'''
    ...

def cov_cluster(results, group, use_correction=...): # -> Any:
...
def cov_cluster_2groups(results, group, group2=..., use_correction=...): # -> tuple[Any | Unknown, Any | Unknown, Any | Unknown]:
...
def cov_white_simple(results, use_correction=...): # -> Any:
    '''
...
def cov_hac_simple(results, nlags=..., weights_func=..., use_correction=...): # -> Any:
    '''
...
cov_hac = ...
def lagged_groups(x, lag, groupidx): # -> tuple[NDArray[_SCT@vstack], NDArray[_SCT@vstack]]:
    '''
...
def cov_nw_panel(results, nlags, groupidx, weights_func=..., use_correction=...): # -> Any:
...
def cov_nw_groupsum(results, nlags, time, weights_func=..., use_correction=...): # -> Any:
