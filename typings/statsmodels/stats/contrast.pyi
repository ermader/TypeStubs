...
class ContrastResults:
    ...
    def conf_int(self, alpha=...): # -> NDArray[_SCT@column_stack]:
        """
    ...
    def summary(self, xname=..., alpha=..., title=...): # -> SimpleTable | str:
    ...
    def summary_frame(self, xname=..., alpha=...): # -> DataFrame:
...
def contrastfromcols(L, D, pseudo=...): # -> Any:
    """
...
class WaldTestResults:
    ...
    @property
    def col_names(self): # -> list[Unknown | str]:
...
def t_test_pairwise(result, term_name, method=..., alpha=..., factor_labels=..., ignore=...): # -> MultiCompResult:
    """
