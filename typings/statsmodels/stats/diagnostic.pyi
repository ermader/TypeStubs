...
def compare_cox(results_x, results_z, store=...): # -> tuple[Unknown, Unknown, ResultsStore] | tuple[Unknown, Unknown]:
    """
...
def compare_j(results_x, results_z, store=...): # -> tuple[Unknown, Unknown, ResultsStore] | tuple[Unknown, Unknown]:
    """
...
def acorr_lm(resid, nlags=..., autolag=..., store=..., *, period=..., ddof=..., cov_type=..., cov_kwargs=...): # -> tuple[Unknown | float, Unknown | float, float, float, ResultsStore] | tuple[Unknown | float, Unknown | float, float, float]:
    """
...
@deprecate_kwarg("maxlag", "nlags")
def het_arch(resid, nlags=..., autolag=..., store=..., ddof=...): # -> Any:
    """
...
def acorr_breusch_godfrey(res, nlags=..., store=...): # -> tuple[Unknown, Unknown, float, float, ResultsStore] | tuple[Unknown, Unknown, float, float]:
    """
...
def het_breuschpagan(resid, exog_het, robust=...): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
    r"""
...
def het_white(resid, exog): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
    """
...
def linear_lm(resid, exog, func=...): # -> tuple[Unknown, Unknown, Unknown]:
    """
...
def spec_white(resid, exog): # -> tuple[Any, Unknown, Unknown]:
    """
...
def recursive_olsresiduals(res, skip=..., lamda=..., alpha=..., order_by=...): # -> tuple[NDArray[floating[Any]], NDArray[floating[Any]], NDArray[floating[Any]], Any, NDArray[floating[Any]], Any, Any]:
    """
...
def breaks_cusumolsresid(resid, ddof=...): # -> tuple[Any, Unknown, list[tuple[Literal[1], float] | tuple[Literal[5], float] | tuple[Literal[10], float]]]:
    """
