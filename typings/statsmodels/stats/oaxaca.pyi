...
class OaxacaBlinder:
    ...
    Gap: 158.75044
    """
    def __init__(self, endog, exog, bifurcate, hasconst=..., swap=..., cov_type=..., cov_kwds=...) -> None:
        ...
    
    def variance(self, decomp_type, n=..., conf=...):
        """
    ...
    def three_fold(self, std=..., n=..., conf=...): # -> OaxacaResults:
        """
    ...
    def two_fold(self, std=..., two_fold_type=..., submitted_weight=..., n=..., conf=...): # -> OaxacaResults:
        """
