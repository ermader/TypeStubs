...
def multinomial_proportions_confint(counts, alpha=..., method=...): # -> NDArray[_SCT@array]:
...
def binom_tost(count, nobs, low, upp): # -> tuple[Any, Unknown, Unknown]:
...
def binom_tost_reject_interval(low, upp, nobs, alpha=...): # -> tuple[Unknown, Unknown]:
...
def binom_test_reject_interval(value, nobs, alpha=..., alternative=...): # -> tuple[Unknown | Literal[0], Unknown]:
...
def power_ztost_prop(low, upp, nobs, p_alt, alpha=..., dist=..., variance_prop=..., discrete=..., continuity=..., critval_continuity=...): # -> tuple[Any, tuple[tuple[Any | Unknown, Any | Unknown, Unknown, Unknown]]]:
...
def proportions_ztest(count, nobs, value=..., alternative=..., prop_var=...): # -> tuple[Unknown | Any, Unknown]:
    """
...
def proportions_ztost(count, nobs, low, upp, prop_var=...): # -> tuple[Any, tuple[Unknown | Any, Unknown], tuple[Unknown | Any, Unknown]]:
...
def proportions_chisquare(count, nobs, value=...): # -> tuple[Unknown, Unknown, tuple[NDArray[_SCT@column_stack], NDArray[_SCT@column_stack] | Any]]:
...
def power_proportions_2indep(diff, prop2, nobs1, ratio=..., alpha=..., value=..., alternative=..., return_results=...): # -> Holder | Literal[0]:
