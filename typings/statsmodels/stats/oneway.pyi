...
"""
def effectsize_oneway(means, vars_, nobs, use_var=..., ddof_between=...):
    """
...
def convert_effectsize_fsqu(f2=..., eta2=...): # -> Holder:
...
def f2_to_wellek(f2, n_groups): # -> Any:
...
def confint_noncentrality(f_stat, df, alpha=..., alternative=...): # -> Any:
    """
...
def confint_effectsize_oneway(f_stat, df, alpha=..., nobs=...): # -> Holder:
    """
...
def anova_generic(means, variances, nobs, use_var=..., welch_correction=..., info=...): # -> HolderTuple:
    """
...
def anova_oneway(data, groups=..., use_var=..., welch_correction=..., trim_frac=...): # -> HolderTuple:
    """Oneway Anova
...
def equivalence_oneway_generic(f_stat, n_groups, nobs, equiv_margin, df, alpha=..., margin_type=...): # -> HolderTuple:
...
def equivalence_oneway(data, equiv_margin, groups=..., use_var=..., welch_correction=..., trim_frac=..., margin_type=...): # -> HolderTuple:
...
def power_equivalence_oneway(f2_alt, equiv_margin, nobs_t, n_groups=..., df=..., alpha=..., margin_type=...):
    """
...
def simulate_power_equivalence_oneway(means, nobs, equiv_margin, vars_=..., k_mc=..., trim_frac=..., options_var=..., margin_type=...): # -> Holder:
...
def test_scale_oneway(data, method=..., center=..., transform=..., trim_frac_mean=..., trim_frac_anova=...): # -> HolderTuple:
...
def equivalence_scale_oneway(data, equiv_margin, method=..., center=..., transform=..., trim_frac_mean=..., trim_frac_anova=...): # -> HolderTuple:
