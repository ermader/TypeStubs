...
(1969), pp. 387–389.
"""
def ksstat(x, cdf, alternative=..., args=...): # -> Any:
    """
...
def get_lilliefors_table(dist=...): # -> TableDist:
    """
...
lilliefors_table_norm = ...
lilliefors_table_expon = ...
def pval_lf(d_max, n): # -> Any:
    """
...
def kstest_fit(x, dist=..., pvalmethod=...): # -> tuple[Any | Unknown, Any | Unknown | NDArray[floating[Any]]]:
    """
