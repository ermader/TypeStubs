...
"""
def ttest_power(effect_size, nobs, alpha, df=..., alternative=...): # -> float | Literal[0]:
    '''Calculate power of a ttest
    '''
    ...

def normal_power(effect_size, nobs, alpha, alternative=..., sigma=...): # -> Literal[0]:
...
def normal_power_het(diff, nobs, alpha, std_null=..., std_alternative=..., alternative=...): # -> Literal[0]:
    """Calculate power of a normal distributed test statistic
...
class Power:
    ...
    def plot_power(self, dep_var=..., nobs=..., effect_size=..., alpha=..., ax=..., title=..., plt_kwds=..., **kwds): # -> Figure:
        """
...
class TTestPower(Power):
    ...
    '''
    def power(self, effect_size, nobs, alpha, df=..., alternative=...): # -> float | Literal[0]:
...
class TTestIndPower(Power):
    ...
    '''
    def power(self, effect_size, nobs1, alpha, ratio=..., df=..., alternative=...): # -> float | Literal[0]:
...
class NormalIndPower(Power):
    ...
    def power(self, effect_size, nobs1, alpha, ratio=..., alternative=...): # -> Literal[0]:
