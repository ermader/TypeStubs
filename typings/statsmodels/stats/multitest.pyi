...
def fdrcorrection(pvals, alpha=..., method=..., is_sorted=...): # -> tuple[Any | NDArray[bool_], ndarray[Any, dtype[Any]]]:
    '''
...
def local_fdr(zscores, null_proportion=..., null_pdf=..., deg=..., nbins=..., alpha=...): # -> Any:
    """
