...
def mnc2cum(mnc): # -> list[Unknown] | NDArray[Any]:
    """convert non-central moments to cumulants
    recursive formula produces as many cumulants as moments
...
def mc2cum(mc): # -> list[Unknown] | NDArray[Any]:
    """
    just chained because I have still the test case
    """
    ...

def mvsk2mc(args): # -> tuple[Unknown, ...]:
    """convert mean, variance, skew, kurtosis to central moments"""
    ...

def mvsk2mnc(args): # -> tuple[Unknown, ...] | NDArray[_SCT@apply_along_axis]:
    """convert mean, variance, skew, kurtosis to non-central moments"""
    ...

def mc2mvsk(args): # -> tuple[Unknown, ...] | NDArray[_SCT@apply_along_axis]:
    """convert central moments to mean, variance, skew, kurtosis"""
    ...

def mnc2mvsk(args): # -> tuple[Unknown, ...] | NDArray[_SCT@apply_along_axis]:
    """convert central moments to mean, variance, skew, kurtosis
    """
    ...

def cov2corr(cov, return_std=...): # -> tuple[Unknown, NDArray[Any]]:
    """
