...
class HolderTuple(Holder):
    ...
    def __iter__(self): # -> Generator[Any | Unknown, None, None]:
        ...
    ...
    def __array__(self, dtype=...): # -> NDArray[_SCT@asarray]:
        ...
...
class AllPairsResults:
    ...
    def pval_corrected(self, method=...): # -> Any | NDArray[floating[Any]] | NDArray[_NumberType@__neg__] | NDArray[_SCT@asarray]:
    ...
    def pval_table(self): # -> NDArray[float64]:
