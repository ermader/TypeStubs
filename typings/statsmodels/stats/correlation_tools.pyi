...
License: BSD-3
"""
def clip_evals(x, value=...): # -> tuple[Any, bool_]:
    ...

def corr_nearest(corr, threshold=..., n_fact=...): # -> Any:
    '''
...
def cov_nearest(cov, method=..., threshold=..., n_fact=..., return_all=...): # -> tuple[Unknown, Unknown | Any, NDArray[Any] | Unknown]:
    """
...
def kernel_covariance(exog, loc, groups, kernel=..., bw=...): # -> (x: Unknown, y: Unknown) -> (NDArray[floating[Any]] | float | Any):
    """
