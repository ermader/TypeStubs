...
License: BSD-3
"""
def test_mvmean(data, mean_null=..., return_results=...): # -> HolderTuple | tuple[Any, Unknown]:
...
def test_mvmean_2indep(data1, data2): # -> HolderTuple:
...
def confint_mvmean(data, lin_transf=..., alpha=..., simult=...): # -> tuple[Unknown, Unknown, Unknown]:
...
def confint_mvmean_fromstats(mean, cov, nobs, lin_transf=..., alpha=..., simult=...): # -> tuple[Unknown, Unknown, Unknown]:
    """Confidence interval for linear transformation of a multivariate mean
...
def test_cov(cov, nobs, cov_null): # -> HolderTuple:
...
def test_cov_spherical(cov, nobs): # -> HolderTuple:
...
def test_cov_diagonal(cov, nobs): # -> HolderTuple:
...
def test_cov_blockdiagonal(cov, nobs, block_len): # -> HolderTuple:
...
def test_cov_oneway(cov_list, nobs_list): # -> HolderTuple:
