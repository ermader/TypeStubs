...
class DescrStatsW:
    ...
    def quantile(self, probs, return_pandas=...): # -> Series[Unknown] | Any | DataFrame | NDArray[_SCT@column_stack]:
        """
    ...
    def tconfint_mean(self, alpha=..., alternative=...): # -> tuple[Unknown | float, Unknown | float]:
    ...
    def zconfint_mean(self, alpha=..., alternative=...): # -> tuple[Unknown | float, Unknown | float]:
        """two-sided confidence interval for weighted mean of data
    ...
    def ttest_mean(self, value=..., alternative=...): # -> tuple[Any, Unknown | Unbound, Any]:
    ...
    def ttost_mean(self, low, upp): # -> tuple[Any, tuple[Any, Unknown, Any], tuple[Any, Unknown, Any]]:
    ...
    def ztest_mean(self, value=..., alternative=...): # -> tuple[Any, Unknown | Unbound]:
    ...
    def ztost_mean(self, low, upp): # -> tuple[Any, tuple[Any, Unknown], tuple[Any, Unknown]]:
    ...
    def asrepeats(self): # -> ndarray[Unknown, Unknown]:
...
class CompareMeans:
    ...
    @classmethod
    def from_data(cls, data1, data2, weights1=..., weights2=..., ddof1=..., ddof2=...): # -> Self@CompareMeans:
    ...
    def ttest_ind(self, alternative=..., usevar=..., value=...): # -> tuple[Unknown, Unknown, Unknown]:
    ...
    def ztest_ind(self, alternative=..., usevar=..., value=...): # -> tuple[Unknown, Unknown]:
    ...
    def tconfint_diff(self, alpha=..., alternative=..., usevar=...): # -> tuple[Unknown | float, Unknown | float]:
    ...
    def zconfint_diff(self, alpha=..., alternative=..., usevar=...): # -> tuple[Unknown | float, Unknown | float]:
        """confidence interval for the difference in means
    ...
    def ttost_ind(self, low, upp, usevar=...): # -> tuple[Any, tuple[tuple[Unknown, Unknown, Unknown], tuple[Unknown, Unknown, Unknown]]]:
        """
    ...
    def ztost_ind(self, low, upp, usevar=...): # -> tuple[Any, tuple[Unknown, Unknown], tuple[Unknown, Unknown]]:
        """
...
def ttest_ind(x1, x2, alternative=..., usevar=..., weights=..., value=...): # -> tuple[Unknown, Unknown, Unknown]:
...
def ttost_ind(x1, x2, low, upp, usevar=..., weights=..., transform=...): # -> tuple[Any, tuple[Unknown, Unknown, Unknown], tuple[Unknown, Unknown, Unknown]]:
...
def ttost_paired(x1, x2, low, upp, transform=..., weights=...): # -> tuple[Any, tuple[Any, Unknown, Any], tuple[Any, Unknown, Any]]:
...
def ztest(x1, x2=..., value=..., alternative=..., usevar=..., ddof=...): # -> tuple[Any, Unknown]:
...
def zconfint(x1, x2=..., value=..., alpha=..., alternative=..., usevar=..., ddof=...): # -> tuple[Unknown | float, Unknown | float]:
...
def ztost(x1, low, upp, x2=..., usevar=..., ddof=...): # -> tuple[Any, tuple[Any, Unknown], tuple[Any, Unknown]]:
