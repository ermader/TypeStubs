...
"""
def durbin_watson(resids, axis=...): # -> Any:
    r"""
...
def omni_normtest(resids, axis=...): # -> tuple[float, float]:
    """
...
def jarque_bera(resids, axis=...): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
    r"""
...
def robust_skewness(y, axis=...): # -> tuple[Unknown, Any, Any, Any]:
    """
...
def expected_robust_kurtosis(ab=..., dg=...): # -> NDArray[float64]:
    """
...
def robust_kurtosis(y, axis=..., ab=..., dg=..., excess=...): # -> tuple[Unknown, Any, Any, Any]:
    """
...
def medcouple(y, axis=...): # -> floating[Any] | NDArray[_SCT@apply_along_axis]:
    """
