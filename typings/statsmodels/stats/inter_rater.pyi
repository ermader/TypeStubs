...
def aggregate_raters(data, n_cat=...): # -> tuple[NDArray[Any], NDArray[_SCT@unique] | NDArray[signedinteger[Any]]]:
...
def to_table(data, bins=...): # -> tuple[NDArray[Any], NDArray[floating[Any]] | Unknown]:
...
def cohens_kappa(table, weights=..., return_results=..., wt=...):
