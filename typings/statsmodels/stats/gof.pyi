...
def gof_chisquare_discrete(distfn, arg, rvs, alpha, msg): # -> tuple[Unknown, Unknown, Unknown, str]:
...
def gof_binning_discrete(rvs, distfn, arg, nsupp=...): # -> tuple[NDArray[_SCT@array], NDArray[signedinteger[Any]], NDArray[floating[Any]]]:
...
def chisquare(f_obs, f_exp=..., value=..., ddof=..., return_basic=...): # -> tuple[Unknown, Unknown]:
