...
"""
class _Bunch:
    def __repr__(self): # -> Literal['<bunch containing results, print to see contents>']:
        ...
...
class Table:
    ...
    @classmethod
    def from_data(cls, data, shift_zeros=...): # -> Self@Table:
        """
    ...
    def test_nominal_association(self): # -> _Bunch:
        """
    ...
    def test_ordinal_association(self, row_scores=..., col_scores=...): # -> _Bunch:
        """
    ...
    @cache_readonly
    def marginal_probabilities(self): # -> tuple[Series[Any] | Any, Series[Any] | Any]:
        """
    ...
    @cache_readonly
    def independence_probabilities(self): # -> DataFrame | NDArray[bool_]:
        """
    ...
    @cache_readonly
    def standardized_resids(self): # -> Any:
        """
    ...
    @cache_readonly
    def local_log_oddsratios(self): # -> DataFrame | NDArray[floating[_NBit1@__imul__]]:
        """
    ...
    @cache_readonly
    def local_oddsratios(self): # -> NDArray[Any]:
        """
    ...
    @cache_readonly
    def cumulative_log_oddsratios(self): # -> DataFrame | NDArray[floating[_NBit1@__imul__]]:
        """
    ...
    @cache_readonly
    def cumulative_oddsratios(self): # -> NDArray[Any]:
        """
...
class SquareTable(Table):
    ...
    def symmetry(self, method=...): # -> _Bunch:
        """
    ...
    def homogeneity(self, method=...): # -> _Bunch:
        """
...
class Table2x2(SquareTable):
    ...
    @classmethod
    def from_data(cls, data, shift_zeros=...): # -> Self@Table2x2:
        """
        Construct a Table object from data.
    ...
    def log_oddsratio_confint(self, alpha=..., method=...): # -> tuple[Unknown, Unknown]:
        """
    ...
    def oddsratio_confint(self, alpha=..., method=...): # -> tuple[Any, Any]:
        """
    ...
    def log_riskratio_confint(self, alpha=..., method=...): # -> tuple[Unknown, Unknown]:
        """
    ...
    def riskratio_confint(self, alpha=..., method=...): # -> tuple[Any, Any]:
        """
...
class StratifiedTable:
    ...
    @classmethod
    def from_data(cls, var1, var2, strata, data): # -> Self@StratifiedTable:
        """
    ...
    def test_null_odds(self, correction=...): # -> _Bunch:
        """
    ...
    @cache_readonly
    def logodds_pooled_se(self): # -> Any:
        """
    ...
    def logodds_pooled_confint(self, alpha=..., method=...): # -> tuple[Unknown, Unknown]:
        """
    ...
    def oddsratio_pooled_confint(self, alpha=..., method=...): # -> tuple[Any, Any]:
        """
    ...
    def test_equal_odds(self, adjust=...): # -> _Bunch:
        """
...
def mcnemar(table, exact=..., correction=...): # -> _Bunch:
    """
...
def cochrans_q(x, return_object=...): # -> _Bunch | tuple[Any, Unknown, int]:
    """
