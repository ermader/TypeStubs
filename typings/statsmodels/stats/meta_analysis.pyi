...
class CombineResults:
    ...
    def conf_int_samples(self, alpha=..., use_t=..., nobs=..., ci_func=...): # -> tuple[Unknown, Unknown]:
    ...
    def conf_int(self, alpha=..., use_t=...): # -> tuple[Unknown, Unknown, Unknown, Unknown]:
    ...
    def test_homogeneity(self): # -> HolderTuple:
    ...
    def summary_array(self, alpha=..., use_t=...): # -> tuple[Unknown, list[str]]:
    ...
    def summary_frame(self, alpha=..., use_t=...): # -> DataFrame:
    ...
    def plot_forest(self, alpha=..., use_t=..., use_exp=..., ax=..., **kwds): # -> Figure:
...
def effectsize_smd(mean1, sd1, nobs1, mean2, sd2, nobs2): # -> tuple[Unknown, Unknown]:
...
def effectsize_2proportions(count1, nobs1, count2, nobs2, statistic=..., zero_correction=..., zero_kwds=...): # -> tuple[Any | Unknown, Unknown]:
...
def combine_effects(effect, variance, method_re=..., row_names=..., use_t=..., alpha=..., **kwds): # -> CombineResults:
