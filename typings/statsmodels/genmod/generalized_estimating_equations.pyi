...
class GEE(GLM):
    ...
    def cluster_list(self, array): # -> list[NDArray[_SCT@array]]:
        """
    ...
    def estimate_scale(self): # -> float | NDArray[Any] | Any:
        """
    ...
    def mean_deriv_exog(self, exog, params, offset_exposure=...): # -> NDArray[bool_]:
        """
    ...
    def qic(self, params, scale, cov_params, n_step=...): # -> tuple[Unknown, Unknown, Unknown]:
        """
...
class GEEResults(GLMResults):
    ...
    @cache_readonly
    def resid_split(self): # -> list[Unknown]:
        """
    ...
    @cache_readonly
    def resid_centered_split(self): # -> list[Unknown]:
        """
    ...
    def qic(self, scale=..., n_step=...): # -> tuple[Unknown, Unknown]:
        """
    ...
    def conf_int(self, alpha=..., cols=..., cov_type=...): # -> NDArray[_SCT@asarray]:
        """
    ...
    def sensitivity_params(self, dep_params_first, dep_params_last, num_steps): # -> list[Unknown]:
        """
...
class OrdinalGEE(GEE):
    ...
    def setup_ordinal(self, endog, exog, groups, time, offset): # -> tuple[Series[Unknown] | NDArray[_SCT@zeros], DataFrame, NDArray[_SCT@zeros], NDArray[_SCT@zeros], NDArray[_SCT@zeros]]:
        """
...
class NominalGEE(GEE):
    ...
    def mean_deriv_exog(self, exog, params, offset_exposure=...): # -> Any:
        """
...
class GEEMargins:
    ...
    def conf_int(self, alpha=...): # -> NDArray[_SCT@asarray]:
        """
