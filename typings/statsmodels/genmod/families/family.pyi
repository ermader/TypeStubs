...
class Family:
    ...
    def deviance(self, endog, mu, var_weights=..., freq_weights=..., scale=...): # -> Any:
        r"""
    ...
    def loglike(self, endog, mu, var_weights=..., freq_weights=..., scale=...): # -> Any:
        r"""
...
class Poisson(Family):
    ...
    def get_distribution(self, mu, scale=..., var_weights=...):
        r"""
...
class Gamma(Family):
    ...
    def loglike_obs(self, endog, mu, var_weights=..., scale=...): # -> Any:
        r"""
        The log-likelihood function for each observation in terms of the fitted
...
class Binomial(Family):
    ...
    def initialize(self, endog, freq_weights): # -> tuple[Unknown, Unknown] | tuple[Unknown, NDArray[float64]]:
        '''
    ...
    def get_distribution(self, mu, scale=..., var_weights=..., n_trials=...):
        r"""
