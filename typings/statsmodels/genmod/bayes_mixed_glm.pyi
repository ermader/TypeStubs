...
class _BayesMixedGLM(base.Model):
    ...
    def logposterior_grad(self, params): # -> NDArray[_SCT@concatenate]:
        """
...
class _VariationalBayesMixedGLM:
    ...
    def vb_elbo_grad_base(self, h, tm, tv, fep_mean, vcp_mean, vc_mean, fep_sd, vcp_sd, vc_sd): # -> tuple[NDArray[_SCT@concatenate], NDArray[_SCT@concatenate]]:
        """
...
class BayesMixedGLMResults:
    ...
    def cov_params(self): # -> DataFrame | Series[Unknown] | Unknown:
        ...
...
class BinomialBayesMixedGLM(_VariationalBayesMixedGLM, _BayesMixedGLM):
    ...
    def vb_elbo_grad(self, vb_mean, vb_sd): # -> tuple[NDArray[_SCT@concatenate], NDArray[_SCT@concatenate]]:
        """
