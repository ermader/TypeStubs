...
class Independence(CovStruct):
    ...
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[_SCT@eye], Literal[True]]:
        ...
    
    @Appender(CovStruct.covariance_matrix_solve.__doc__)
    def covariance_matrix_solve(self, expval, index, stdev, rhs): # -> list[Unknown]:
        ...
    
    def summary(self): # -> Literal['Observations within a cluster are modeled as being independent.']:
        ...
...
class Unstructured(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, endog_expval, index): # -> tuple[Any | Unknown, Literal[True]] | tuple[NDArray[float64] | Unknown, Literal[True]]:
        ...
...
class Exchangeable(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[floating[Any]] | Unknown, Literal[True]]:
        ...
...
class Nested(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[_SCT@eye], Literal[True]] | tuple[Unknown, Literal[True]]:
        ...
...
class Stationary(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, endog_expval, index): # -> tuple[Unknown, Literal[True]] | tuple[NDArray[float64], Literal[True]]:
        ...
    
    def covariance_matrix_grid(self, endog_expval, index): # -> tuple[Unknown, Literal[True]]:
        ...
...
class Autoregressive(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, endog_expval, index): # -> tuple[NDArray[_SCT@eye], Literal[True]] | tuple[NDArray[floating[Any]] | Any | NDArray[signedinteger[Any]] | Unknown, Literal[True]]:
        ...
...
class GlobalOddsRatio(CategoricalCovStruct):
    ...
    def pooled_odds_ratio(self, tables): # -> float | Any:
        """
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expected_value, index): # -> tuple[Unknown, Literal[False]]:
        ...
    
    def observed_crude_oddsratio(self): # -> float | Any:
        """
    ...
    def get_eyy(self, endog_expval, index): # -> NDArray[bool_]:
        """
...
class OrdinalIndependence(CategoricalCovStruct):
    ...
    """
    def covariance_matrix(self, expected_value, index): # -> tuple[NDArray[float64], Literal[False]]:
        ...
...
class Equivalence(CovStruct):
    ...
    @Appender(CovStruct.covariance_matrix.__doc__)
    def covariance_matrix(self, expval, index): # -> tuple[NDArray[floating[Any]], bool]:
        ...
