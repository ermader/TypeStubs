...
class PHReg(model.LikelihoodModel):
    ...
    def fit(self, groups=..., **args): # -> PHRegResults:
        """
    ...
    def fit_regularized(self, method=..., alpha=..., start_params=..., refit=..., **kwargs): # -> RegularizedResultsWrapper | PHRegResults:
        r"""
    ...
    def loglike(self, params): # -> float | Any | None:
        """
    ...
    def breslow_loglike(self, params): # -> float | Any:
        """
    ...
    def efron_loglike(self, params): # -> float | Any:
        """
        Returns the value of the log partial likelihood function
    ...
    def robust_covariance(self, params): # -> Any:
        """
    ...
    def score_residuals(self, params): # -> NDArray[_SCT@zeros]:
        """
    ...
    def weighted_covariate_averages(self, params): # -> list[Unknown]:
        """
    ...
    def baseline_cumulative_hazard(self, params): # -> list[Unknown]:
        """
    ...
    def baseline_cumulative_hazard_function(self, params): # -> dict[Unknown, Unknown]:
        """
...
class PHRegResults(base.LikelihoodModelResults):
    ...
    @cache_readonly
    def standard_errors(self): # -> NDArray[Any]:
        """
    ...
    @cache_readonly
    def schoenfeld_residuals(self): # -> NDArray[floating[Any]]:
        """
    ...
    @cache_readonly
    def martingale_residuals(self): # -> NDArray[floating[Any]]:
        """
