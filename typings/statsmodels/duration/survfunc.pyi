...
class SurvfuncRight:
    ...
    def quantile_ci(self, p, alpha=..., method=...): # -> tuple[float, float] | tuple[Any, float | Any]:
        """
    ...
    def simultaneous_cb(self, alpha=..., method=..., transform=...): # -> tuple[NDArray[floating[Any]] | Any, NDArray[floating[Any]] | Any | NDArray[int8]]:
        """
...
def survdiff(time, status, group, weight_type=..., strata=..., entry=..., **kwargs): # -> tuple[Any | Unknown, Unknown]:
    """
