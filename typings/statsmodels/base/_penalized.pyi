...
class PenalizedMixin:
    ...
    def score_numdiff(self, params, pen_weight=..., method=..., **kwds): # -> NDArray[_SCT@array] | ndarray[Any, dtype[Any]]:
    ...
    def hessian_numdiff(self, params, pen_weight=..., **kwds): # -> NDArray[floating[Any]]:
