...
class LinearConstraints:
    ...
    def __getitem__(self, idx): # -> Unknown:
        ...
    ...
    @classmethod
    def from_patsy(cls, lc): # -> Self@LinearConstraints:
...
def fit_constrained(model, constraint_matrix, constraint_values, start_params=..., fit_kwds=...): # -> tuple[Any | Unknown, Any, Unknown]:
