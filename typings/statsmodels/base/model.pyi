...
class GenericLikelihoodModel(LikelihoodModel):
    ...
    def score(self, params): # -> ndarray[Any, dtype[Any]]:
        """
        Gradient of log-likelihood evaluated at params
        """
        ...
    
    def score_obs(self, params, **kwds): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    def fit(self, start_params=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., retall=..., **kwargs): # -> Any | GenericLikelihoodModelResults:
        ...
...
class LikelihoodModelResults(Results):
    ...
    @cached_value
    def bse(self): # -> NDArray[float64] | NDArray[Any]:
    ...
    def t_test(self, r_matrix, cov_p=..., use_t=...):
        """
    ...
    def wald_test(self, r_matrix, cov_p=..., invcov=..., use_f=..., df_constraints=..., scalar=...):
        """
    ...
    def wald_test_terms(self, skip_single=..., extra_constraints=..., combine_terms=..., scalar=...):
        """
...
class ResultMixin:
    ...
    @cache_readonly
    def covjac(self): # -> NDArray[float64]:
        """
