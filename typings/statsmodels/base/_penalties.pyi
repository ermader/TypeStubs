...
class NonePenalty(Penalty):
    ...
    def func(self, params): # -> NDArray[float64] | Literal[0]:
        ...
    
    def deriv(self, params): # -> NDArray[float64]:
        ...
    
    def deriv2(self, params): # -> NDArray[float64]:
        ...
...
class L2(Penalty):
    ...
    def func(self, params): # -> Any:
        ...
    
    def deriv(self, params):
        ...
    
    def deriv2(self, params): # -> NDArray[floating[Any]]:
        ...
...
class SCAD(Penalty):
    ...
    def deriv(self, params): # -> NDArray[floating[Any]]:
        ...
...
class ConstraintsPenalty:
    ...
    grad = ...
    def deriv2(self, params): # -> NDArray[_SCT@diag]:
...
class PSD(CovariancePenalty):
    ...
    definite matrices.
    """
    def func(self, mat, mat_inv): # -> float:
        ...
