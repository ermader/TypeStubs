...
def drop_missing(Y, X=..., axis=...): # -> tuple[Any, Any] | Any:
    """
...
def add_constant(data, prepend=..., has_constant=...): # -> DataFrame | NDArray[_SCT@column_stack] | ndarray[Any, dtype[Unknown]]:
    """
...
def pinv_extended(x, rcond=...): # -> tuple[Any, NDArray[_SCT@copy]]:
    """
...
def recipr(x): # -> NDArray[_SCT@zeros_like]:
    """
...
def recipr0(x): # -> NDArray[_SCT@zeros_like]:
    """
...
def clean0(matrix): # -> NDArray[_SCT@array]:
    """
...
def fullrank(x, r=...): # -> NDArray[_ScalarType@astype]:
    """
...
def maybe_unwrap_results(results): # -> Any | None:
    """
