...
_hessian_docs = ...
def approx_fprime(x, f, epsilon=..., args=..., kwargs=..., centered=...): # -> ndarray[Any, dtype[Any]]:
    '''
...
def approx_fprime_cs(x, f, epsilon=..., args=..., kwargs=...): # -> NDArray[_SCT@array]:
    '''
...
def approx_hess1(x, f, epsilon=..., args=..., kwargs=..., return_grad=...): # -> tuple[NDArray[floating[Any]], Unknown] | NDArray[floating[Any]]:
    ...
...
""")
@Appender(_hessian_docs)
def approx_hess2(x, f, epsilon=..., args=..., kwargs=..., return_grad=...): # -> tuple[NDArray[floating[Any]], Unknown] | NDArray[floating[Any]]:
    ...
