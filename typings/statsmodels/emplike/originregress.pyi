...
class OriginResults(RegressionResults):
    ...
    def el_test(self, b0_vals, param_nums, method=..., stochastic_exog=..., return_weights=...): # -> tuple[Unknown, Unknown, Unknown] | tuple[Unknown, Unknown]:
        """
    ...
    def conf_int_el(self, param_num, upper_bound=..., lower_bound=..., sig=..., method=..., stochastic_exog=...): # -> tuple[Unknown, Unknown]:
        """
