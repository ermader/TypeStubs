...
class AFTResults(OptAFT):
    ...
    def test_beta(self, b0_vals, param_nums, ftol=..., maxiter=..., print_weights=...): # -> tuple[Any, Unknown] | tuple[Unknown, Unknown] | tuple[float, Literal[0]]:
        """
    ...
    def ci_beta(self, param_num, beta_high, beta_low, sig=...): # -> tuple[Unknown, Unknown]:
        """
