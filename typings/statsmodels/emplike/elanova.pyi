...
class ANOVA(_ANOVAOpt):
    ...
    def compute_ANOVA(self, mu=..., mu_start=..., return_weights=...): # -> tuple[Any, Unknown, Unknown, Unknown] | tuple[Any, Unknown, Unknown] | tuple[Unknown, Unknown, float, Unknown] | tuple[Unknown, Unknown, float]:
        """
