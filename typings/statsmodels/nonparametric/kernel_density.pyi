...
class KDEMultivariate(GenericKDE):
    ...
    def loo_likelihood(self, bw, func=...): # -> Literal[0]:
        r"""
    ...
    def pdf(self, data_predict=...): # -> ndarray[Unknown, Unknown]:
        r"""
    ...
    def cdf(self, data_predict=...): # -> ndarray[Unknown, Unknown]:
        r"""
...
class KDEMultivariateConditional(GenericKDE):
    ...
    def pdf(self, endog_predict=..., exog_predict=...): # -> ndarray[Unknown, Unknown]:
        r"""
        Evaluate the probability density function.
    ...
    def cdf(self, endog_predict=..., exog_predict=...): # -> NDArray[float64]:
        r"""
