...
class KDEUnivariate:
    ...
    def __init__(self, endog: list[float]) -> None: ...
    def fit(
        self,
        kernel: str = ...,
        bw: typing.Union[str, float] = ...,
        fft: bool = ...,
        weights: typing.Optional[list[float]] = ...,
        gridsize: typing.Optional[int] = ...,
        adjust: float = ...,
        cut: float = ...,
        ...
        ...
    @cache_readonly
    def cdf(self):  # -> ndarray[Unknown, Unknown]:
        """
        ...
        ...
    @cache_readonly
    def cumhazard(self):  # -> NDArray[_NumberType@__neg__]:
        """
        ...
        ...
    @cache_readonly
    def sf(self):  # -> NDArray[signedinteger[Any]]:
        """
    ...
    def icdf(self):
        ...
        """
        ...
    def evaluate(self, point: typing.Union[float, list[float]]) -> typing.Any:
        """
...
def kdensity(
    ...
    cut=...,
    retgrid=...,
):  # -> tuple[Unknown, ndarray[Unknown, Unknown], Unknown] | tuple[Unknown, Unknown]:
    """
...
def kdensityfft(
    ...
    cut=...,
    retgrid=...,
):  # -> tuple[NDArray[floating[Any]], ndarray[Unknown, Unknown], Unknown] | tuple[NDArray[floating[Any]], Unknown]:
    """
    Rosenblatt-Parzen univariate kernel density estimator
