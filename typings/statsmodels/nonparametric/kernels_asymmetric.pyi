...
"""
doc_params = ...
def pdf_kernel_asym(x, sample, bw, kernel_type, weights=..., batch_size=...): # -> NDArray[_SCT@concatenate]:
...
def cdf_kernel_asym(x, sample, bw, kernel_type, weights=..., batch_size=...): # -> NDArray[_SCT@concatenate]:
