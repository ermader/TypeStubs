...
def webuse(data, baseurl=..., as_df=...): # -> DataFrame:
    """
...
def process_pandas(data, endog_idx=..., exog_idx=..., index_idx=...): # -> Dataset:
    ...

def get_rdataset(dataname, package=..., cache=...): # -> Dataset:
...
def load_csv(base_file, csv_name, sep=..., convert_float=...): # -> DataFrame:
