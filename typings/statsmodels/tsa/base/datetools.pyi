...
_q_pattern = ...
_m_pattern = ...
def date_parser(timestr, parserinfo=..., **kwargs): # -> Series[datetime64] | datetime:
    """
...
def dates_from_str(dates): # -> list[Unknown]:
    """
...
def dates_from_range(start, end=..., length=...): # -> list[Unknown]:
    """
    Turns a sequence of date strings and returns a list of datetime.
