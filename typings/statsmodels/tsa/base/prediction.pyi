...
class PredictionResults:
    ...
    @property
    def row_labels(self): # -> Any | None:
        """The row labels used in pandas-types."""
        ...
    
    @property
    def predicted_mean(self): # -> NDArray[_SCT@asarray] | Series[Unknown] | DataFrame:
        """The predicted mean"""
        ...
    
    @property
    def var_pred_mean(self): # -> NDArray[_SCT@asarray] | Series[Unknown] | DataFrame:
        """The variance of the predicted mean"""
        ...
    
    @property
    def se_mean(self): # -> NDArray[Any] | Series[Unknown] | DataFrame:
        """The standard deviation of the predicted mean"""
        ...
    
    @property
    def tvalues(self): # -> Series[Unknown] | NDArray[float64] | NDArray[floating[Any]] | DataFrame:
        """The ratio of the predicted mean to its standard deviation"""
        ...
    
    def t_test(self, value=..., alternative=...): # -> tuple[NDArray[float64] | NDArray[floating[Any]] | Series[Unknown] | DataFrame, Unknown]:
        """
    ...
    def conf_int(self, alpha=...): # -> NDArray[_SCT@column_stack] | Series[Unknown] | DataFrame:
        """
