...
def cy_hamilton_filter_log(initial_probabilities, regime_transition, conditional_loglikelihoods, model_order): # -> tuple[ndarray[Any, dtype[Any]] | Any, NDArray[Any], NDArray[float64], ndarray[Any, dtype[Any]], NDArray[float64], ndarray[Any, dtype[float64]]]:
    """
...
def cy_kim_smoother_log(regime_transition, predicted_joint_probabilities, filtered_joint_probabilities): # -> tuple[NDArray[Any], NDArray[Any] | Any]:
    """
...
class MarkovSwitching(tsbase.TimeSeriesModel):
    ...
    """
    def __init__(self, endog, k_regimes, order=..., exog_tvtp=..., exog=..., dates=..., freq=..., missing=...) -> None:
        ...
    ...
    def initialize_known(self, probabilities, tol=...): # -> None:
        """
        Set initialization of regime probabilities to use known values
        """
        ...
    
    def initial_probabilities(self, params, regime_transition=...):
        """
        Retrieve initial probabilities
        """
        ...
    
    def regime_transition_matrix(self, params, exog_tvtp=...): # -> NDArray[_SCT@zeros]:
        """
    ...
    def predict(self, params, start=..., end=..., probabilities=..., conditional=...): # -> Any:
        """
    ...
    def filter(self, params, transformed=..., cov_type=..., cov_kwds=..., return_raw=..., results_class=..., results_wrapper_class=...): # -> MarkovSwitchingResultsWrapper:
        """
    ...
    def smooth(self, params, transformed=..., cov_type=..., cov_kwds=..., return_raw=..., results_class=..., results_wrapper_class=...): # -> MarkovSwitchingResultsWrapper:
        """
    ...
    def loglikeobs(self, params, transformed=...): # -> NDArray[float64]:
        """
    ...
    def loglike(self, params, transformed=...): # -> Any:
        """
    ...
    def score(self, params, transformed=...): # -> NDArray[_SCT@array]:
        """
    ...
    def score_obs(self, params, transformed=...): # -> NDArray[_SCT@array]:
        """
    ...
    def hessian(self, params, transformed=...): # -> NDArray[floating[Any]]:
        """
    ...
    def fit(self, start_params=..., transformed=..., cov_type=..., cov_kwds=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., return_params=..., em_iter=..., search_reps=..., search_iter=..., search_scale=..., **kwargs): # -> NDArray[_ScalarType@astype] | MarkovSwitchingResultsWrapper:
        """
    ...
    @property
    def start_params(self): # -> NDArray[_SCT@zeros]:
        """
    ...
    def transform_params(self, unconstrained): # -> NDArray[_ScalarType@astype]:
        """
    ...
    def untransform_params(self, constrained): # -> NDArray[_ScalarType@astype]:
        """
...
class HamiltonFilterResults:
    ...
    @property
    def predicted_marginal_probabilities(self): # -> Any:
        ...
    
    @property
    def expected_durations(self): # -> ndarray[Any, Unknown]:
        """
...
class MarkovSwitchingResults(tsbase.TimeSeriesModelResults):
    ...
    @property
    def joint_likelihoods(self): # -> Any:
        ...
    
    def predict(self, start=..., end=..., probabilities=..., conditional=...):
        """
        In-sample prediction and out-of-sample forecasting
    ...
    def summary(self, alpha=..., start=..., title=..., model_name=..., display_params=...):
        """
        Summarize the Model
