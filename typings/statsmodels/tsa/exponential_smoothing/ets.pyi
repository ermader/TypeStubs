...
class ETSModel(base.StateSpaceMLEModel):
    ...
    @staticmethod
    def prepare_data(data): # -> tuple[NDArray[Any] | NDArray[_SCT@array], None]:
        """
    ...
    def smooth(self, params, return_raw=...): # -> tuple[Series[Unknown] | NDArray[float64], DataFrame | NDArray[float64]]:
        """
    ...
    def score(self, params, approx_centered=..., approx_complex_step=..., **kwargs): # -> NDArray[_SCT@array] | ndarray[Any, dtype[Any]]:
        ...
...
class PredictionResults:
    ...
    **simulate_kwargs :
    ...
    @property
    def var_pred_mean(self): # -> Scalar | Any:
        """The variance of the predicted mean"""
        ...
    
    def pred_int(self, alpha=...): # -> DataFrame | NDArray[_SCT@vstack]:
        """
