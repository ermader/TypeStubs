...
class SARIMAXParams:
    ...
    @property
    def seasonal_ar_poly(self): # -> Polynomial:
    ...
    @property
    def seasonal_ma_poly(self): # -> Polynomial:
    ...
    @property
    def is_stationary(self): # -> bool_ | Literal[True]:
        """(bool) Is the reduced autoregressive lag poylnomial stationary."""
        ...
    
    @property
    def is_invertible(self): # -> bool_ | Literal[True]:
    ...
    def to_pandas(self): # -> Series[Unknown]:
        """
