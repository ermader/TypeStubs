...
class SARIMAXSpecification:
    ...
    @property
    def is_ar_consecutive(self): # -> bool | Any:
        """
    ...
    @property
    def is_ma_consecutive(self): # -> bool | Any:
        """
    ...
    def split_params(self, params, allow_infnan=...): # -> dict[str, NDArray[_SCT@split]]:
        """
    ...
    def join_params(self, exog_params=..., ar_params=..., ma_params=..., seasonal_ar_params=..., seasonal_ma_params=..., sigma2=...): # -> NDArray[_SCT@concatenate]:
        """
    ...
    def construct_trend_data(self, nobs, offset=...): # -> NDArray[float64] | None:
        ...
    
    def construct_trend_names(self): # -> list[Unknown]:
        ...
