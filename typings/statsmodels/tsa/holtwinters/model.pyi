...
SMOOTHERS = ...
PY_SMOOTHERS = ...
def opt_wrapper(func): # -> (*args: Unknown, **kwargs: Unknown) -> (NDArray[bool_] | Unknown):
    ...
...
class ExponentialSmoothing(TimeSeriesModel):
    ...
    def predict(self, params, start=..., end=...): # -> Any:
        """
...
class SimpleExpSmoothing(ExponentialSmoothing):
    ...
    def fit(self, smoothing_level=..., *, optimized=..., start_params=..., initial_level=..., use_brute=..., use_boxcox=..., remove_bias=..., method=..., minimize_kwargs=...): # -> Any:
        """
        Fit the model
...
class Holt(ExponentialSmoothing):
    ...
    @deprecate_kwarg("initial_slope", "initial_trend")
    @deprecate_kwarg("damping_slope", "damping_trend")
    def fit(self, smoothing_level=..., smoothing_trend=..., *, damping_trend=..., optimized=..., start_params=..., initial_level=..., initial_trend=..., use_brute=..., use_boxcox=..., remove_bias=..., method=..., minimize_kwargs=...): # -> Any:
        """
        Fit the model
