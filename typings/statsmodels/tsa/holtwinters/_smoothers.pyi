...
class HoltWintersArgs:
    ...
    @property
    def lvl(self): # -> NDArray[float64]:
        ...
    
    @property
    def b(self): # -> NDArray[float64]:
        ...
...
def to_restricted(p, sel, bounds): # -> tuple[Unknown, Unknown, Unknown]:
    """
...
def to_unrestricted(p, sel, bounds): # -> tuple[Unknown, Unknown, Unknown]:
    """
...
def holt_init(x, hw_args: HoltWintersArgs): # -> tuple[Unknown, Unknown, Unknown, Unknown, Unknown, Unknown]:
    """
...
def holt_win_init(x, hw_args: HoltWintersArgs): # -> tuple[Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown, Unknown]:
