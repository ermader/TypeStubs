...
class _freq_to_period:
    def __getitem__(self, key): # -> Literal[12, 4, 52] | None:
        ...
...
_log_to_x12 = ...
_bool_to_yes_no = ...
def run_spec(x12path, specpath, outname=..., meta=..., datameta=...): # -> Popen[bytes]:
    ...
...
def pandas_to_series_spec(x): # -> SeriesSpec:
    ...
...
@deprecate_kwarg("forecast_years", "forecast_periods")
def x13_arima_select_order(endog, maxorder=..., maxdiff=..., diff=..., exog=..., log=..., outlier=..., trading=..., forecast_periods=..., start=..., freq=..., print_stdout=..., x12path=..., prefer_x13=...): # -> Bunch:
    """
