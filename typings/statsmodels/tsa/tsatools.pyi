...
__all__ = ["lagmat", "lagmat2ds", "add_trend", "duplication_matrix", "elimination_matrix", "commutation_matrix", "vec", "vech", "unvec", "unvech", "freq_to_period", "rename_trend"]
...
def lagmat(x, maxlag: int, trim: Literal[forward, backward, both, none] = ..., original: Literal[ex, sep, <Expression>] = ..., use_pandas: bool = ...): # -> tuple[Unknown | ndarray[Any, dtype[float64]], Unknown | Unbound | ndarray[Any, dtype[float64]]] | ndarray[Any, dtype[float64]]:
    """
...
def unvech(v): # -> NDArray[floating[Any]]:
    ...

def duplication_matrix(n): # -> NDArray[_SCT@array]:
    """
...
def commutation_matrix(p, q): # -> float64:
    """
...
def unintegrate_levels(x, d): # -> NDArray[_SCT@asarray]:
    """
...
def unintegrate(x, levels): # -> ndarray[Unknown, Unknown]:
    """
...
def freq_to_period(freq): # -> Literal[1, 4, 12, 52, 7, 5, 24]:
    """
...
def rename_trend(trend: str): # -> str:
    ...
