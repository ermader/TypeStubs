...
SQRTEPS = ...
def adfuller(x, maxlag: int | None = ..., regression=..., autolag=..., store=..., regresults=...): # -> tuple[Unknown, float | Unknown, dict[str, Any], ResultsStore | Unbound] | tuple[Unknown, float | Unknown, Unknown | int, Unknown | int, dict[str, Any]] | tuple[Unknown, float | Unknown, Unknown | int, Unknown | int, dict[str, Any], Unknown | Any | float | None]:
    """
...
def q_stat(x, nobs): # -> tuple[Unknown, Unknown]:
    """
...
def acf(x, adjusted=..., nlags=..., qstat=..., fft=..., alpha=..., bartlett_confint=..., missing=...): # -> Any | tuple[Any, NDArray[_SCT@array]] | tuple[Any, NDArray[_SCT@array] | Unbound, Unknown, Unknown] | tuple[Any, Unknown, Unknown] | None:
    """
...
def pacf_yw(x, nlags=..., method=...): # -> NDArray[Any]:
    """
...
def pacf_burg(x, nlags=..., demean=...): # -> tuple[NDArray[float64], Any | NDArray[floating[Any]]]:
    """
...
@deprecate_kwarg("unbiased", "adjusted")
def pacf_ols(x, nlags=..., efficient=..., adjusted=...): # -> NDArray[floating[_NBit1@__imul__]]:
    """
...
def pacf(x, nlags=..., method=..., alpha=...): # -> tuple[Any | NDArray[Any], NDArray[_SCT@array]] | Any | NDArray[Any]:
    """
...
@deprecate_kwarg("unbiased", "adjusted")
def ccovf(x, y, adjusted=..., demean=..., fft=...): # -> NDArray[float64] | NDArray[floating[Any]] | Any:
    """
...
def levinson_durbin(s, nlags=..., isacov=...): # -> tuple[Any, ndarray[Any, dtype[Any]], NDArray[_SCT@diag], NDArray[float64], NDArray[Any]]:
    """
...
def levinson_durbin_pacf(pacf, nlags=...): # -> tuple[ndarray[Any, Unknown], NDArray[float64]]:
    """
...
def breakvar_heteroskedasticity_test(resid, subset_length=..., alternative=..., use_f=...):
    r"""
...
def coint(y0, y1, trend=..., method=..., maxlag=..., autolag: str | None = ..., return_results=...): # -> tuple[Unknown | float, float | Unknown, list[float] | ndarray[Any, dtype[Any]] | NDArray[floating[Any]]]:
    """
...
def range_unit_root_test(x, store=...): # -> tuple[Unknown, float, dict[str, Any], ResultsStore] | tuple[Unknown, float, dict[str, Any]]:
    """
...
class ZivotAndrewsUnitRoot:
    ...
    def run(self, x, trim=..., maxlag=..., regression=..., autolag=...): # -> tuple[Any, NDArray[floating[Any]], dict[str, Any], dict[str, Any] | Unknown | int, signedinteger[_NBitIntP]]:
        """
    ...
    def __call__(self, x, trim=..., maxlag=..., regression=..., autolag=...): # -> tuple[Any, NDArray[floating[Any]], dict[str, Any], dict[str, Any] | Unknown | int, signedinteger[_NBitIntP]]:
        ...
