...
"""
def distance_indicators(x, epsilon=..., distance=...): # -> Any:
    """
...
def correlation_sum(indicators, embedding_dim): # -> tuple[Any, Unknown]:
    """
...
def correlation_sums(indicators, max_dim): # -> NDArray[float64]:
    """
...
def bds(x, max_dim=..., epsilon=..., distance=...): # -> tuple[ndarray[Unknown, Unknown], ndarray[Unknown, Unknown]]:
    """
