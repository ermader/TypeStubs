...
class MLEModel(tsbase.TimeSeriesModel):
    ...
    **kwargs
    ...
    def prepare_data(self): # -> tuple[NDArray[_SCT@array], NDArray[_SCT@array] | Unknown | None]:
        """
    ...
    @property
    def initialization(self): # -> Initialization | None:
        ...
    ...
    def loglikeobs(self, params, transformed=..., includes_fixed=..., complex_step=..., **kwargs): # -> NDArray[_SCT@array]:
        """
        Loglikelihood evaluation
    ...
    def opg_information_matrix(self, params, transformed=..., includes_fixed=..., approx_complex_step=..., **kwargs): # -> Any:
        """
    ...
    def score_obs(self, params, method=..., transformed=..., includes_fixed=..., approx_complex_step=..., approx_centered=..., **kwargs): # -> NDArray[floating[Any]] | NDArray[_SCT@array] | ndarray[Any, dtype[Any]]:
        """
    ...
    def transform_jacobian(self, unconstrained, approx_centered=...): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    def update(self, params, transformed=..., includes_fixed=..., complex_step=...): # -> tuple[NDArray[_SCT@array] | NDArray[floating[Any]] | NDArray[_ScalarType@astype], ndarray[Any, dtype[Any]] | Unbound] | NDArray[_SCT@array] | NDArray[floating[Any]] | NDArray[_ScalarType@astype]:
        """
...
class MLEResults(tsbase.TimeSeriesModelResults):
    ...
    def test_normality(self, method): # -> NDArray[_SCT@array]:
        """
    ...
    def test_heteroskedasticity(self, method, alternative=..., use_f=...): # -> Any:
        r"""
    ...
    def test_serial_correlation(self, method, df_adjust=..., lags=...):
        """
    ...
    def get_prediction(self, start=..., end=..., dynamic=..., index=..., exog=..., extend_model=..., extend_kwargs=..., **kwargs): # -> PredictionResultsWrapper:
        """
    ...
    def get_forecast(self, steps=..., **kwargs): # -> PredictionResultsWrapper:
        """
...
class PredictionResults(pred.PredictionResults):
    ...
    def conf_int(self, method=..., alpha=..., **kwds): # -> DataFrame | NDArray[_SCT@column_stack] | Series[Unknown]:
        ...
