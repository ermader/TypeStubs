...
class SmootherResults(FilterResults):
    ...
    @property
    def smoothed_forecasts(self): # -> NDArray[float64]:
        ...
    
    @property
    def smoothed_forecasts_error(self): # -> NDArray[float64] | None:
        ...
    
    @property
    def smoothed_forecasts_error_cov(self): # -> NDArray[float64] | None:
        ...
