...
class DynamicFactorMQStates(dict):
    ...
    @property
    def factors_L1(self): # -> NDArray[_SCT@concatenate]:
        """Factors."""
        ...
    
    @property
    def factors_L1_5_ix(self): # -> NDArray[_SCT@concatenate]:
        """Factors plus any lags, index shaped (5, k_factors)."""
        ...
    
    @property
    def idio_ar_L1(self): # -> slice:
        """Idiosyncratic AR states, (first block / lag only)."""
        ...
    
    @property
    def idio_ar_M(self): # -> slice:
        """Idiosyncratic AR states for monthly variables."""
        ...
    
    @property
    def idio_ar_Q(self): # -> slice:
        """Idiosyncratic AR states and all lags for quarterly variables."""
        ...
    
    @property
    def idio_ar_Q_ix(self): # -> NDArray[signedinteger[Any]]:
        """Idiosyncratic AR (quarterly) state index, (k_endog_Q, lags)."""
        ...
    
    @property
    def endog_factor_iloc(self): # -> list[Unknown]:
...
class DynamicFactorMQ(mlemodel.MLEModel):
    ...
    *Impulse responses*
    ...
    @classmethod
    def construct_endog(cls, endog_monthly, endog_quarterly): # -> tuple[DataFrame | Unknown, int | Unknown]:
        """
    ...
    def clone(self, endog, k_endog_monthly=..., endog_quarterly=..., retain_standardization=..., **kwargs): # -> Self@DynamicFactorMQ:
        """
    ...
    @property
    def state_names(self): # -> list[Unknown]:
        """(list of str) List of human readable names for unobserved states."""
        ...
    
    @property
    def param_names(self): # -> list[Unknown]:
...
class DynamicFactorMQResults(mlemodel.MLEResults):
    ...
    def get_prediction(self, start=..., end=..., dynamic=..., index=..., exog=..., extend_model=..., extend_kwargs=..., original_scale=..., **kwargs): # -> PredictionResultsWrapper:
        """
