...
class UnobservedComponents(MLEModel):
    ...
    **Regression effects**
    ...
    def clone(self, endog, exog=..., **kwargs): # -> Self@UnobservedComponents:
        ...
    
    @property
    def start_params(self): # -> list[Unknown]:
        ...
    ...
    def transform_params(self, unconstrained): # -> NDArray[_SCT@zeros]:
        """
    ...
    def untransform_params(self, constrained): # -> NDArray[_SCT@zeros]:
        """
...
class UnobservedComponentsResults(MLEResults):
    ...
    @property
    def freq_seasonal(self): # -> list[Unknown]:
        """
