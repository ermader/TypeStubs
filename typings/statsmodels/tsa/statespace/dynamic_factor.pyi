...
class DynamicFactor(MLEModel):
    ...
    **kwargs
    ...
    def clone(self, endog, exog=..., **kwargs): # -> Self@DynamicFactor:
        ...
...
class DynamicFactorResults(MLEResults):
    ...
    @cache_readonly
    def coefficients_of_determination(self): # -> NDArray[float64]:
        """
    ...
    def plot_coefficients_of_determination(self, endog_labels=..., fig=..., figsize=...): # -> Figure:
        """
