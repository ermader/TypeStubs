...
class Representation:
    ...
    **kwargs
    ...
    def clone(self, endog, **kwargs): # -> Self@Representation:
        """
    ...
    @property
    def dtype(self): # -> float32 | float64 | complex64 | complex128:
        """
    ...
    @property
    def obs(self): # -> NDArray[_SCT@asfortranarray] | ndarray[Unknown, Unknown] | None:
        r"""
    ...
    def initialize(self, initialization, approximate_diffuse_variance=..., constant=..., stationary_cov=...): # -> None:
