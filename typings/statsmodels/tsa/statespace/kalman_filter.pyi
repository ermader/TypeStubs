...
class KalmanFilter(Representation):
    ...
    **kwargs
    ...
    def loglikeobs(self, **kwargs): # -> NDArray[_SCT@array]:
        r"""
...
class FilterResults(FrozenRepresentation):
    ...
    @property
    def kalman_gain(self): # -> NDArray[float64] | NDArray[_SCT@array]:
        """
    ...
    @property
    def standardized_forecasts_error(self): # -> NDArray[floating[Any]] | NDArray[float64] | NDArray[_SCT@array] | None:
        r"""
