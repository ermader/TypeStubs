...
class SARIMAX(MLEModel):
    ...
    **kwargs
    ...
    def prepare_data(self): # -> tuple[NDArray[Any] | NDArray[_SCT@array], NDArray[Any] | NDArray[_SCT@array] | Unknown | None]:
        ...
    ...
    @property
    def initial_design(self): # -> Any | ndarray[Any, dtype[Unknown]]:
        """Initial design matrix"""
        ...
    
    @property
    def initial_state_intercept(self): # -> NDArray[float64]:
        """Initial state intercept vector"""
        ...
    
    @property
    def initial_transition(self): # -> NDArray[float64]:
        """Initial transition matrix"""
        ...
    
    @property
    def initial_selection(self): # -> NDArray[float64] | Any:
        """Initial selection matrix"""
        ...
    
    def clone(self, endog, exog=..., **kwargs): # -> Self@SARIMAX:
        ...
    
    @property
    def start_params(self): # -> Any:
        """
    ...
    @property
    def model_orders(self): # -> dict[str, int | Unknown | Any]:
        """
...
class SARIMAXResults(MLEResults):
    ...
    @cache_readonly
    def arroots(self): # -> NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]]:
        """
    ...
    @cache_readonly
    def maroots(self): # -> NDArray[complexfloating[Any, Any]] | NDArray[floating[Any]]:
        """
    ...
    @cache_readonly
    def arfreq(self): # -> NDArray[floating[Any]] | None:
        """
    ...
    @cache_readonly
    def mafreq(self): # -> NDArray[floating[Any]] | None:
        """
