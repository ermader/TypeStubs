...
"""
def get_var_endog(y, lags, trend=..., has_constant=...): # -> NDArray[_SCT@array] | DataFrame | NDArray[_SCT@column_stack]:
    """
...
def get_trendorder(trend=...): # -> Literal[1, 0, 2, 3]:
    ...
...
def comp_matrix(coefs): # -> NDArray[float64]:
    """
...
def parse_lutkepohl_data(path): # -> tuple[recarray[Unknown, Unknown], DatetimeIndex]:
    """
...
def varsim(coefs, intercept, sig_u, steps=..., initvalues=..., seed=...): # -> NDArray[float64]:
    """
...
def get_index(lst, name): # -> int:
    ...

def eigval_decomp(sym_array): # -> tuple[Unknown, Unknown, intp]:
    """
    Returns
    -------
...
def vech(A): # -> NDArray[_SCT@asarray]:
    """
...
def seasonal_dummies(n_seasons, len_endog, first_period=..., centered=...): # -> NDArray[float64] | None:
    """
