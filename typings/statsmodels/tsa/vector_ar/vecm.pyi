...
def select_coint_rank(endog, det_order, k_ar_diff, method=..., signif=...): # -> CointRankResults:
...
def coint_johansen(endog, det_order, k_ar_diff): # -> JohansenTestResult:
    """
...
class JohansenTestResult:
    ...
    @property
    def rkt(self): # -> Unknown:
        """Residuals for :math:`Y_{-1}`"""
        ...
    
    @property
    def r0t(self): # -> Unknown:
        """Residuals for :math:`\\Delta Y`."""
        ...
    
    @property
    def eig(self): # -> Unknown:
        """Eigenvalues of VECM coefficient matrix"""
        ...
    
    @property
    def evec(self): # -> Unknown:
        """Eigenvectors of VECM coefficient matrix"""
        ...
    
    @property
    def trace_stat(self): # -> Unknown:
        """Trace statistic"""
        ...
    
    @property
    def lr1(self): # -> Unknown:
        """Trace statistic"""
        ...
    
    @property
    def max_eig_stat(self): # -> Unknown:
        """Maximum eigenvalue statistic"""
        ...
    
    @property
    def lr2(self): # -> Unknown:
        """Maximum eigenvalue statistic"""
        ...
    
    @property
    def trace_stat_crit_vals(self): # -> Unknown:
        """Critical values (90%, 95%, 99%) of trace statistic"""
        ...
    
    @property
    def cvt(self): # -> Unknown:
        """Critical values (90%, 95%, 99%) of trace statistic"""
        ...
    
    @property
    def cvm(self): # -> Unknown:
        """Critical values (90%, 95%, 99%) of maximum eigenvalue statistic."""
        ...
    
    @property
    def max_eig_stat_crit_vals(self): # -> Unknown:
        """Critical values (90%, 95%, 99%) of maximum eigenvalue statistic."""
        ...
    
    @property
    def ind(self): # -> Unknown:
...
class VECM(tsbase.TimeSeriesModel):
    ...
    def fit(self, method=...): # -> VECMResults:
        """
...
class VECMResults:
    ...
    @cache_readonly
    def cov_params_default(self): # -> NDArray[bool_]:
        ...
    
    @cache_readonly
    def cov_params_wo_det(self): # -> Any:
        ...
    
    @cache_readonly
    def stderr_params(self): # -> NDArray[Any]:
        ...
    
    @cache_readonly
    def stderr_coint(self): # -> NDArray[float64]:
        """
    ...
    @cache_readonly
    def stderr_alpha(self): # -> ndarray[Any, dtype[Any]]:
        ...
    
    @cache_readonly
    def stderr_beta(self): # -> ndarray[Any, dtype[float64]]:
        ...
    
    @cache_readonly
    def stderr_det_coef_coint(self): # -> NDArray[_SCT@vsplit] | ndarray[Any, dtype[float64]]:
        ...
    
    @cache_readonly
    def stderr_gamma(self): # -> ndarray[Any, dtype[Any]]:
        ...
    
    @cache_readonly
    def stderr_det_coef(self): # -> NDArray[_SCT@hsplit] | ndarray[Any, dtype[Any]]:
        ...
    
    @cache_readonly
    def tvalues_alpha(self): # -> NDArray[floating[Any]] | NDArray[complexfloating[Any, Any]]:
        ...
    
    @cache_readonly
    def tvalues_beta(self): # -> NDArray[_SCT@vstack]:
        ...
    
    @cache_readonly
    def tvalues_det_coef_coint(self): # -> NDArray[_SCT@vsplit] | NDArray[complexfloating[Any, Any]]:
        ...
    
    @cache_readonly
    def tvalues_gamma(self): # -> NDArray[complexfloating[Any, Any]]:
        ...
    
    @cache_readonly
    def tvalues_det_coef(self): # -> NDArray[_SCT@hsplit] | NDArray[complexfloating[Any, Any]]:
        ...
    ...
    @cache_readonly
    def pvalues_beta(self): # -> NDArray[_SCT@vstack]:
        ...
    
    @cache_readonly
    def pvalues_det_coef_coint(self): # -> NDArray[_SCT@vsplit]:
        ...
    ...
    @cache_readonly
    def pvalues_det_coef(self): # -> NDArray[_SCT@hsplit]:
        ...
    
    def conf_int_alpha(self, alpha=...): # -> NDArray[Any]:
        ...
    
    def conf_int_beta(self, alpha=...): # -> NDArray[Any]:
        ...
    
    def conf_int_det_coef_coint(self, alpha=...): # -> NDArray[Any]:
        ...
    
    def conf_int_gamma(self, alpha=...): # -> NDArray[Any]:
        ...
    
    def conf_int_det_coef(self, alpha=...): # -> NDArray[Any]:
        ...
    
    @cache_readonly
    def var_rep(self): # -> NDArray[float64]:
        ...
    
    @cache_readonly
    def cov_var_repr(self): # -> Any:
        """
    ...
    def plot_forecast(self, steps, alpha=..., plot_conf_int=..., n_last_obs=...): # -> None:
        """
        Plot the forecast.
    ...
    def irf(self, periods=...): # -> IRAnalysis:
        ...
    ...
    def plot_data(self, with_presample=...): # -> None:
        """
