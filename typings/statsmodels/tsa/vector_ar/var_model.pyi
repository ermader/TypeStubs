...
"""
def ma_rep(coefs, maxn=...): # -> NDArray[float64]:
    r"""
...
def is_stable(coefs, verbose=...): # -> bool_:
    """
...
def var_acf(coefs, sig_u, nlags=...): # -> NDArray[float64]:
    """
...
def forecast_cov(ma_coefs, sigma_u, steps): # -> NDArray[float64]:
    r"""
...
def forecast_interval(y, coefs, trend_coefs, sig_u, steps=..., alpha=..., exog=...): # -> tuple[Any | Unknown | NDArray[float64], Unknown, Unknown]:
    ...
...
def orth_ma_rep(results, maxn=..., P=...): # -> NDArray[_SCT@array]:
...
def test_normality(results, signif=...): # -> NormalityTestResults:
    """
...
class VAR(TimeSeriesModel):
    ...
    def predict(self, params, start=..., end=..., lags=..., trend=...): # -> NDArray[_SCT@array] | NDArray[floating[_NBit1@__iadd__]]:
        """
        Returns in-sample predictions or forecasts
        """
        ...
    
    def fit(self, maxlags: int | None = ..., method=..., ic=..., trend=..., verbose=...): # -> VARResultsWrapper:
        """
        Fit the VAR model
    ...
    def select_order(self, maxlags=..., trend=...): # -> LagOrderResults:
        """
...
class VARProcess:
    ...
    def get_eq_index(self, name): # -> int:
    ...
    def is_stable(self, verbose=...): # -> bool_:
    ...
    def simulate_var(self, steps=..., offset=..., seed=...): # -> NDArray[floating[_NBit1@__iadd__]]:
        """
    ...
    def plotsim(self, steps=..., offset=..., seed=...): # -> Figure:
        """
    ...
    def intercept_longrun(self): # -> NDArray[floating[Any]]:
        r"""
    ...
    def ma_rep(self, maxn=...): # -> NDArray[float64]:
        r"""
    ...
    def orth_ma_rep(self, maxn=..., P=...): # -> NDArray[_SCT@array]:
        r"""
    ...
    def long_run_effects(self): # -> NDArray[float64]:
    ...
    def acf(self, nlags=...): # -> NDArray[float64]:
    ...
    def acorr(self, nlags=...): # -> NDArray[floating[Any]]:
        """
    ...
    def plot_acorr(self, nlags=..., linewidth=...): # -> Figure:
    ...
    def mse(self, steps): # -> NDArray[float64]:
        r"""
        Compute theoretical forecast error variance matrices
    ...
    forecast_cov = ...
    def forecast_interval(self, y, steps, alpha=..., exog_future=...): # -> tuple[Any | Unknown | NDArray[float64], Unknown, Unknown]:
        """
    ...
    def to_vecm(self): # -> dict[str, NDArray[_SCT@concatenate] | Any]:
        """to_vecm"""
        ...
...
class VARResults(VARProcess):
    ...
    def sample_acov(self, nlags=...): # -> NDArray[floating[Any]]:
        """Sample acov"""
        ...
    
    def sample_acorr(self, nlags=...): # -> NDArray[floating[Any]]:
        """Sample acorr"""
        ...
    
    def plot_sample_acorr(self, nlags=..., linewidth=...): # -> Figure:
        """
    ...
    def resid_acov(self, nlags=...): # -> NDArray[floating[Any]]:
        """
    ...
    def resid_acorr(self, nlags=...): # -> NDArray[floating[Any]]:
        """
    ...
    def cov_params(self): # -> NDArray[floating[Any]]:
    ...
    @cache_readonly
    def stderr(self): # -> ndarray[Any, dtype[Any]]:
        """Standard errors of coefficients, reshaped to match in size"""
        ...
    
    bse = ...
    @cache_readonly
    def stderr_endog_lagged(self): # -> ndarray[Any, dtype[Any]]:
        """Stderr_endog_lagged"""
        ...
    
    @cache_readonly
    def stderr_dt(self): # -> ndarray[Any, dtype[Any]]:
        """Stderr_dt"""
        ...
    ...
    def plot_forecast(self, steps, alpha=..., plot_stderr=...): # -> Figure:
        """
        Plot forecast
        """
        ...
    
    def forecast_cov(self, steps=..., method=...): # -> NDArray[float64]:
    ...
    def irf_errband_mc(self, orth=..., repl=..., steps=..., signif=..., seed=..., burn=..., cum=...): # -> tuple[ndarray[Any, Unknown], ndarray[Any, Unknown]]:
        """
    ...
    def irf_resim(self, orth=..., repl=..., steps=..., seed=..., burn=..., cum=...): # -> NDArray[float64]:
        """
    ...
    def irf(self, periods=..., var_decomp=..., var_order=...): # -> IRAnalysis:
    ...
    def fevd(self, periods=..., var_decomp=...): # -> FEVD:
        """
    ...
    def reorder(self, order): # -> VARResults:
    ...
    def test_inst_causality(self, causing, signif=...): # -> CausalityTestResults:
        """
    ...
    def test_whiteness(self, nlags=..., signif=..., adjusted=...): # -> WhitenessTestResults:
        """
    ...
    def plot_acorr(self, nlags=..., resid=..., linewidth=...): # -> Figure:
        r"""
    ...
    def test_normality(self, signif=...): # -> NormalityTestResults:
        """
        Test assumption of normal-distributed errors using Jarque-Bera-style
        omnibus Chi^2 test.
    ...
    @cache_readonly
    def info_criteria(self): # -> dict[str, Unknown | float]:
...
class FEVD:
    ...
    def plot(self, periods=..., figsize=..., **plot_kwds): # -> Figure:
