...
Author: Josef-pktd
"""
def fftconvolveinv(in1, in2, mode=...): # -> None:
    """
...
def recursive_filter(x, ar_coeff, init=...): # -> NDArray[_SCT@asarray] | Series[Unknown] | DataFrame:
    """
...
def miso_lfilter(ar, ma, x, useic=...): # -> tuple[Unknown, Unknown]:
    """
