...
class multivariate_normal_gen(multi_rv_generic):
    ...
    def cdf(self, x, mean=..., cov=..., allow_singular=..., maxpts=..., abseps=..., releps=...): # -> Any | ndarray[Any, dtype[Any]]:
        """
    ...
    def rvs(self, mean=..., cov=..., size=..., random_state=...):
        """
        Draw random samples from a multivariate normal distribution.
...
class multivariate_normal_frozen(multi_rv_frozen):
    ...
    def cdf(self, x): # -> Any | ndarray[Any, dtype[Any]]:
        ...
