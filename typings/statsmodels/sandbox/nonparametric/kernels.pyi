...
class CustomKernel:
    ...
    h = ...
    def in_domain(self, xs, ys, x): # -> tuple[Unknown, Unknown] | tuple[tuple[Unknown], tuple[Unknown]] | tuple[list[Unknown], list[Unknown]]:
        """
    ...
    def density_confint(self, density, nobs, alpha=...): # -> NDArray[_SCT@column_stack]:
    ...
    def smoothconf(self, xs, ys, x, alpha=...): # -> tuple[Unknown, Any | float, Unknown] | tuple[float, float, float]:
...
class Biweight(CustomKernel):
    ...
    def smoothconf_(self, xs, ys, x): # -> tuple[Unknown, Any | float, Unknown] | tuple[float, float, float]:
        """Returns the kernel smoothing estimate with confidence 1sigma bounds
        """
        ...
