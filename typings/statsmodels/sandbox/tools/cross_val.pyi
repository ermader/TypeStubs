...
class LeaveOneOut:
    ...
    def __iter__(self): # -> Generator[tuple[NDArray[Any], NDArray[Any]], None, None]:
        ...
...
def split(train_indexes, test_indexes, *args): # -> list[Unknown]:
    """
...
class KStepAhead:
    ...
    def __iter__(self): # -> Generator[tuple[slice, slice] | tuple[NDArray[Any], NDArray[Any]], None, None]:
        ...
