...
class Runs:
    ...
    def runs_test(self, correction=...): # -> tuple[Any, Unknown]:
...
def runstest_1samp(x, cutoff=..., correction=...): # -> tuple[Any, Unknown]:
...
def runstest_2samp(x, y=..., groups=..., correction=...): # -> tuple[Any, Unknown]:
...
class TotalRunsProb:
    ...
    *Status*
    ...
    def pdf(self, r): # -> NDArray[float64]:
        ...
...
def median_test_ksample(x, groups): # -> tuple[Unknown, NDArray[_SCT@vstack], NDArray[_SCT@vstack]]:
...
def cochrans_q(x): # -> tuple[Any, Unknown]:
...
def mcnemar(x, y=..., exact=..., correction=...): # -> tuple[Any, Any | Unknown]:
    '''McNemar test
...
def symmetry_bowker(table): # -> tuple[Any, Unknown, float]:
