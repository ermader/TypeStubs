...
def Tukeythreegene(first, second, third): # -> list[Unknown]:
    ...
...
def catstack(args): # -> tuple[NDArray[_SCT@hstack], NDArray[_SCT@hstack]]:
    ...

def maxzero(x): # -> tuple[Any | None, NDArray[signedinteger[Any]]]:
...
def maxzerodown(x): # -> tuple[Any | None, NDArray[signedinteger[Any]]]:
    '''find all up zero crossings and return the index of the highest
...
def rejectionline(n, alpha=...): # -> NDArray[floating[Any]]:
...
def fdrcorrection_bak(pvals, alpha=..., method=...): # -> Any:
...
def mcfdr(nrepl=..., nobs=..., ntests=..., ntrue=..., mu=..., alpha=..., rho=...): # -> NDArray[_SCT@array]:
    '''MonteCarlo to test fdrcorrection
    '''
    ...

def randmvn(rho, size=..., standardize=...): # -> Any | ndarray[Any, dtype[float64]]:
...
class MultiComparison:
    ...
    def kruskal(self, pairs=..., multimethod=...): # -> None:
        '''
    ...
    def allpairtest(self, testfunc, alpha=..., method=..., pvalidx=...): # -> tuple[SimpleTable, tuple[NDArray[_SCT@array], Any | NDArray[bool_], Any | NDArray[floating[Any]] | NDArray[_NumberType@__neg__] | NDArray[_SCT@asarray], Any, float], NDArray[Any]]:
...
def varcorrection_pairs_unbalanced(nobs_all, srange=...): # -> NDArray[floating[Any]]:
...
def varcorrection_unequal(var_all, nobs_all, df_all): # -> tuple[Unknown, Unknown]:
...
def varcorrection_pairs_unequal(var_all, nobs_all, df_all): # -> tuple[NDArray[floating[Any]], NDArray[floating[Any]]]:
    '''return joint variance from samples with unequal variances and unequal
...
def tukeyhsd(mean_all, nobs_all, var_all, df=..., alpha=..., q_crit=...): # -> tuple[tuple[NDArray[int_], NDArray[int_]], Unknown, Unknown, Any, NDArray[_SCT@column_stack], Unknown, Unknown | Any, Unknown, NDArray[_SCT@atleast_1d]]:
...
def distance_st_range(mean_all, nobs_all, var_all, df=..., triu=...): # -> tuple[Unknown | Any, Unknown, Unknown | NDArray[Any], tuple[NDArray[int_], NDArray[int_]]]:
...
def contrast_allpairs(nm): # -> NDArray[_SCT@array]:
...
def contrast_all_one(nm): # -> NDArray[_SCT@column_stack]:
...
def tukey_pvalues(std_range, nm, df): # -> tuple[Unknown, NDArray[_SCT@asarray]]:
    ...

def multicontrast_pvalues(tstat, tcorr, df=..., dist=..., alternative=...): # -> tuple[Unknown, NDArray[_SCT@asarray]]:
...
class StepDown:
    ...
    def iter_subsets(self, indices): # -> Generator[Unknown, None, None]:
        """Iterate substeps"""
        ...
    ...
    def run(self, alpha): # -> tuple[list[Unknown], list[Unknown]]:
...
def homogeneous_subsets(vals, dcrit): # -> tuple[list[Unknown], list[tuple[int, int]], list[Unknown], list[Unknown | tuple[Unknown, Unknown]] | Unknown]:
...
def set_partition(ssli): # -> tuple[list[Unknown], list[Unknown]]:
...
def set_remove_subs(ssli): # -> list[Unknown]:
