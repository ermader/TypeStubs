...
EXP_UPPER_LIMIT = np.log(np.finfo(np.float64).max) - 1
...
class DiscreteModel(base.LikelihoodModel):
    ...
    def cov_params_func_l1(self, likelihood_model, xopt, retvals): # -> NDArray[floating[Any]]:
        """
...
class MultinomialModel(BinaryModel):
    ...
    def predict(self, params, exog=..., linear=...): # -> NDArray[_SCT@column_stack] | Any:
        """
        Predict response variable of a model given exogenous variables.
...
class GeneralizedPoisson(CountModel):
    ...
    @Appender("""
        ...
        """)
    @Appender(DiscreteModel.fit.__doc__)
    def fit(self, start_params=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., use_transparams=..., cov_type=..., cov_kwds=..., use_t=..., optim_kwds_prelim=..., **kwargs):
        ...
    ...
    def score_obs(self, params): # -> NDArray[_SCT@concatenate]:
        ...
    
    def score(self, params): # -> Any:
        ...
    
    def hessian(self, params): # -> NDArray[float64]:
        """
    ...
    def predict(self, params, exog=..., exposure=..., offset=..., which=...): # -> Any:
        """
        Predict response variable of a count model given exogenous variables.
...
class Logit(BinaryModel):
    __doc__ = ...
    _continuous_ok = ...
    def cdf(self, X): # -> NDArray[floating[Any]]:
        """
...
class MNLogit(MultinomialModel):
    ...
    def hessian(self, params): # -> ndarray[Any, Unknown]:
        """
...
class NegativeBinomial(CountModel):
    ...
    def score_obs(self, params): # -> NDArray[_SCT@array]:
        ...
    
    def fit(self, start_params=..., method=..., maxiter=..., full_output=..., disp=..., callback=..., cov_type=..., cov_kwds=..., use_t=..., optim_kwds_prelim=..., **kwargs):
        ...
...
class NegativeBinomialP(CountModel):
    ...
    def convert_params(self, params, mu): # -> tuple[Unknown, Unknown]:
        ...
...
class MultinomialResults(DiscreteResults):
    ...
    def pred_table(self): # -> NDArray[float64]:
        """
    ...
    @cache_readonly
    def bse(self): # -> ndarray[Any, dtype[Any]]:
        ...
