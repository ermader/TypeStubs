...
class RLMResults(base.LikelihoodModelResults):
    ...
    @cache_readonly
    def bcov_unscaled(self): # -> () -> Unknown:
        ...
    ...
    def summary(self, yname=..., xname=..., title=..., alpha=..., return_fmt=...): # -> Summary:
        """
        This is for testing the new summary setup
        """
        ...
    
    def summary2(self, xname=..., yname=..., title=..., alpha=..., float_format=...): # -> Summary:
