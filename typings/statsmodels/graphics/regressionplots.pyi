...
def plot_fit(results, exog_idx, y_true=..., ax=..., vlines=..., **kwargs): # -> Figure:
    """
...
def plot_partregress(endog, exog_i, exog_others, data=..., title_kwargs=..., obs_labels=..., label_kwargs=..., ax=..., ret_coords=..., eval_env=..., **kwargs):
...
def plot_partregress_grid(results, exog_idx=..., grid=..., fig=...): # -> Figure:
    """
...
def plot_ccpr_grid(results, exog_idx=..., grid=..., fig=...): # -> Figure:
    """
...
def influence_plot(results, external=..., alpha=..., criterion=..., size=..., plot_alpha=..., ax=..., **kwargs): # -> Figure:
    ...

@Appender(_plot_leverage_resid2_doc.format({ 'extra_params_doc': "results : object\n" "    Results for a fitted regression model" }))
def plot_leverage_resid2(results, alpha=..., ax=..., **kwargs): # -> Figure:
    ...

@Appender(_plot_added_variable_doc % { 'extra_params_doc': "results : object\n" "    Results for a fitted regression model" })
def plot_added_variable(results, focus_exog, resid_type=..., use_glm_weights=..., fit_kwargs=..., ax=...): # -> Figure:
    ...

@Appender(_plot_partial_residuals_doc % { 'extra_params_doc': "results : object\n" "    Results for a fitted regression model" })
def plot_partial_residuals(results, focus_exog, ax=...): # -> Figure:
    ...

@Appender(_plot_ceres_residuals_doc % { 'extra_params_doc': "results : Results\n" "        Results instance of a fitted regression " "model." })
def plot_ceres_residuals(results, focus_exog, frac=..., cond_means=..., ax=...): # -> Figure:
    ...
