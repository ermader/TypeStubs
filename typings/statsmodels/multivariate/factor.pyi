...
class Factor(Model):
    ...
    **Experimental**
    ...
    @property
    def endog_names(self): # -> NDArray[_SCT@asarray] | Any | list[str]:
    ...
    def fit(self, maxiter=..., tol=..., start=..., opt_method=..., opt=..., em_iter=...): # -> FactorResults:
        """
    ...
    def score(self, par): # -> NDArray[floating[Any]]:
        """
...
class FactorResults:
    ...
    def factor_score_params(self, method=...): # -> ndarray[Unknown, Unknown] | Any:
        """
    ...
    def factor_scoring(self, endog=..., method=..., transform=...): # -> Any:
        """
    ...
    def plot_scree(self, ncomp=...): # -> Figure:
        """
    ...
    def plot_loadings(self, loading_pairs=..., plot_prerotated=...): # -> list[Unknown]:
        """
