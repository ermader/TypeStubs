...
class PCA:
    ...
    (100, 1)
    """
    def __init__(self, data, ncomp=..., standardize=..., demean=..., normalize=..., gls=..., weights=..., method=..., missing=..., tol=..., max_iter=..., tol_em=..., max_em_iter=..., svd_full_matrices=...) -> None:
        ...
    ...
    def plot_scree(self, ncomp=..., log_scale=..., cumulative=..., ax=...): # -> Figure:
        """
    ...
    def plot_rsquare(self, ncomp=..., ax=...): # -> Figure:
        """
...
def pca(data, ncomp=..., standardize=..., demean=..., normalize=..., gls=..., weights=..., method=...): # -> tuple[Unknown | Any | DataFrame | None, Unknown | ndarray[Any, dtype[float64]] | DataFrame | None, Unknown | DataFrame | None, Any | Series[Any] | None, NDArray[signedinteger[Any]] | DataFrame | None, Unknown | NDArray[float64] | Any | Series[Unknown] | None, Unknown | NDArray[float64] | DataFrame | None]:
    """
