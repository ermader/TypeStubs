...
class MixedLM(base.LikelihoodModel):
    ...
    def group_list(self, array): # -> list[NDArray[_SCT@array]] | None:
        """
    ...
    def score(self, params, profile_fe=...): # -> NDArray[_SCT@concatenate]:
        """
    ...
    def score_sqrt(self, params, calc_fe=...): # -> tuple[Unknown, Unknown, Unknown]:
        """
...
class MixedLMResults(base.LikelihoodModelResults, base.ResultMixin):
    ...
    @cache_readonly
    def random_effects(self): # -> dict[Unknown, Unknown]:
        """
    ...
    @cache_readonly
    def random_effects_cov(self): # -> dict[Unknown, Unknown]:
        """
