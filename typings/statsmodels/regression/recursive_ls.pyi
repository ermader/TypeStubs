...
class RecursiveLS(MLEModel):
    ...
    @classmethod
    def from_formula(cls, formula, data, subset=..., constraints=...): # -> Self@Model:
        ...
    ...
    @property
    def start_params(self): # -> NDArray[float64]:
        ...
...
class RecursiveLSResults(MLEResults):
    ...
    @cache_readonly
    def llf_recursive_obs(self): # -> Any:
        """
    ...
    def get_prediction(self, start=..., end=..., dynamic=..., index=..., **kwargs): # -> PredictionResultsWrapper:
        ...
